...
class PhoneMetadata(UnicodeMixin, ImmutableMixin):
    @classmethod
    def metadata_for_region(kls: PhoneMetadata, region_code: str, default: Optional[PhoneMetadata] = ...) -> Optional[PhoneMetadata]: ...  # type: ignore[misc]
    @classmethod
    def short_metadata_for_region(kls: PhoneMetadata, region_code: str, default: Optional[PhoneMetadata] = ...) -> Optional[PhoneMetadata]: ...  # type: ignore[misc]
    @classmethod
    def metadata_for_nongeo_region(kls: PhoneMetadata, country_code: int, default: Optional[PhoneMetadata] = ...) -> Optional[PhoneMetadata]: ...  # type: ignore[misc]
    @classmethod
    def metadata_for_region_or_calling_code(kls: PhoneMetadata, country_calling_code: int, region_code: str) -> Optional[PhoneMetadata]: ...  # type: ignore[misc]
    @classmethod
    def register_region_loader(kls: PhoneMetadata, region_code: str, loader: Callable[[str], ModuleType]) -> None: ...  # type: ignore[misc]
    @classmethod
    def register_short_region_loader(kls: PhoneMetadata, region_code: str, loader: Callable[[str], ModuleType]) -> None: ...  # type: ignore[misc]
    @classmethod
    def register_nongeo_region_loader(kls: PhoneMetadata, country_code: str, loader: Callable[[str], ModuleType]) -> None: ...  # type: ignore[misc]
    @classmethod
    def load_all(kls: PhoneMetadata) -> None: ...  # type: ignore[misc]
