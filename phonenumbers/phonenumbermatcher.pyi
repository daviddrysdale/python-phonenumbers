...
class PhoneNumberMatcher:
    ...
    _max_tries: int
    _state: int
    _last_match: Optional[PhoneNumberMatch]
    _search_index: int
    def __init__(self, text: Optional[str], region: Optional[str], leniency: int = ..., max_tries: int = ...) -> None: ...
    def _find(self, index: int) -> Optional[PhoneNumberMatch]: ...
    ...
    def _extract_match(self, candidate: str, offset: int) -> Optional[PhoneNumberMatch]: ...
    def _extract_inner_match(self, candidate: str, offset: int) -> Optional[PhoneNumberMatch]: ...
    def _parse_and_verify(self, candidate: str, offset: int) -> Optional[PhoneNumberMatch]: ...
