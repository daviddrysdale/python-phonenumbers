...
def _format_nsn(number: str, metadata: PhoneMetadata, num_format: int, carrier_code: Optional[int] = ...) -> str: ...
def _choose_formatting_pattern_for_number(available_formats: list[NumberFormat], national_number: str) -> Optional[NumberFormat]: ...
def _format_nsn_using_pattern(national_number: str, formatting_pattern: NumberFormat, number_format: int, carrier_code: Optional[int] = ...) -> str: ...
