...
def _desc_has_possible_number_data(desc: Optional[PhoneNumberDesc]) -> bool: ...
def _desc_has_data(desc: Optional[PhoneNumberDesc]) -> bool: ...
...
def _formatting_rule_has_first_group_only(national_prefix_formatting_rule: Optional[str]) -> bool: ...
def is_number_geographical(numobj: PhoneNumber) -> bool: ...
def is_number_type_geographical(num_type: int, country_code: int) -> bool: ...
def _is_valid_region_code(region_code: Optional[str]) -> bool: ...
...
def _format_nsn(number: str, metadata: PhoneMetadata, num_format: int, carrier_code: Optional[str] = ...) -> str: ...
def _choose_formatting_pattern_for_number(available_formats: list[NumberFormat], national_number: str) -> Optional[NumberFormat]: ...
def _format_nsn_using_pattern(national_number: str, formatting_pattern: NumberFormat, number_format: int, carrier_code: Optional[str] = ...) -> str: ...
...
def _example_number_anywhere_for_type(num_type: int) -> Optional[PhoneNumber]: ...
...
def _number_desc_by_type(metadata: PhoneMetadata, num_type: int) -> Optional[PhoneNumberDesc]: ...
def number_type(numobj: PhoneNumber) -> int: ...
def _number_type_helper(national_number: str, metadata: PhoneMetadata) -> int: ...
def _is_number_matching_desc(national_number: str, number_desc: Optional[PhoneNumberDesc]) -> bool: ...
def is_valid_number(numobj: PhoneNumber) -> bool: ...
def is_valid_number_for_region(numobj: PhoneNumber, region_code: str) -> bool: ...
def region_code_for_number(numobj: PhoneNumber) -> Optional[str]: ...
def region_code_for_country_code(country_code: int) -> str: ...
def _region_code_for_number_from_list(numobj: PhoneNumber, regions: tuple[str, ...]) -> Optional[str]: ...
...
def ndd_prefix_for_region(region_code: str, strip_non_digits: bool) -> Optional[str]: ...
...
def _check_region_for_parsing(number: Optional[str], default_region: Optional[str]) -> bool: ...
...
def is_number_match(num1: Union[PhoneNumber, str], num2: Union[PhoneNumber, str]) -> int: ...
...
def _match_national_number(number: str, number_desc: Optional[PhoneNumberDesc], allow_prefix_match: bool) -> bool: ...
