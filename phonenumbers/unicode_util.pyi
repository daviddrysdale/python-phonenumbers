...
class _BlockRange(UnicodeMixin):
    ...
    def __init__(self, start: int, end: int, regdict: Optional[dict[int, _BlockRange]] = ...) -> None: ...
    def __eq__(self, other: _BlockRange) -> bool: ...  # type: ignore[override]
    def __ne__(self, other: _BlockRange) -> bool: ...  # type: ignore[override]
    def __hash__(self) -> int: ...
    def __unicode__(self) -> str: ...

class Block:
    _RANGES: dict[int, _BlockRange]
    _RANGE_KEYS: Optional[list[int]]
...
def digit(uni_char: str, default_value: Optional[int] = ...) -> int: ...
