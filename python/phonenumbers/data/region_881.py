...
PHONE_METADATA_881 = PhoneMetadata(id='001', country_code=881, international_prefix=None,
    general_desc=PhoneNumberDesc(national_number_pattern='[67]\\d{8}', possible_number_pattern='\\d{9}', example_number='612345678', possible_length=(9,)),
    fixed_line=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA', example_number='612345678'),
    mobile=PhoneNumberDesc(national_number_pattern='[67]\\d{8}', possible_number_pattern='\\d{9}', example_number='612345678', possible_length=(9,)),
