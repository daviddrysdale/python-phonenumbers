...
PHONE_METADATA_882 = PhoneMetadata(id='001', country_code=882, international_prefix=None,
    general_desc=PhoneNumberDesc(national_number_pattern='[13]\\d{6,11}', possible_number_pattern='\\d{7,12}', example_number='3451234567', possible_length=(7, 8, 9, 10, 11, 12)),
    fixed_line=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA', example_number='3451234567'),
    mobile=PhoneNumberDesc(national_number_pattern='3(?:2\\d{3}|37\\d{2}|4(?:2|7\\d{3}))\\d{4}', possible_number_pattern='\\d{7,10}', example_number='3451234567', possible_length=(7, 9, 10)),
