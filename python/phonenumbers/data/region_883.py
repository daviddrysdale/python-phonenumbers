...
PHONE_METADATA_883 = PhoneMetadata(id='001', country_code=883, international_prefix=None,
    general_desc=PhoneNumberDesc(national_number_pattern='210\\d{7}|51\\d{7}(?:\\d{3})?', possible_length=(9, 10, 12)),
    voip=PhoneNumberDesc(national_number_pattern='(?:210|51[013]0\\d)\\d{7}|5100\\d{5}', example_number='510012345', possible_length=(9, 10, 12)),
