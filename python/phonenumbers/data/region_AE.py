...
PHONE_METADATA_AE = PhoneMetadata(id='AE', country_code=971, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='5[0256]\\d{7}', possible_number_pattern='\\d{9}', example_number='501234567'),
    ...
    number_format=[NumberFormat(pattern='([2-4679])(\\d{3})(\\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[2-4679][2-8]'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(5[0256])(\\d{3})(\\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['5'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='([479]00)(\\d)(\\d{5})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[479]0'], national_prefix_formatting_rule=u'\\1'),
        NumberFormat(pattern='([68]00)(\\d{2,9})', format=u'\\1 \\2', leading_digits_pattern=['60|8'], national_prefix_formatting_rule=u'\\1')])
