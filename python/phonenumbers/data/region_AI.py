...
PHONE_METADATA_AI = PhoneMetadata(id='AI', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2644(?:6[12]|9[78])\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='2644612345', possible_length=(10,), possible_length_local_only=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='264(?:235|476|5(?:3[6-9]|8[1-4])|7(?:29|72))\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='2642351234', possible_length=(10,), possible_length_local_only=(7,)),
