...
PHONE_METADATA_AM = PhoneMetadata(id='AM', country_code=374, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[1-36-9]\\d{7}', possible_number_pattern='\\d{5,8}'),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:77|9[1-46-9])\\d{6}', possible_number_pattern='\\d{8}', example_number='77123456'),
