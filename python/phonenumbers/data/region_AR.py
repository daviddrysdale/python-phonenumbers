...
PHONE_METADATA_AR = PhoneMetadata(id='AR', country_code=54, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='([68]\\d{2})(\\d{3})(\\d{4})', format=u'\\1-\\2-\\3', leading_digits_pattern=['[68]'], national_prefix_formatting_rule=u'0\\1'),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{4})', format=u'\\1 \\2-\\3', leading_digits_pattern=['2(?:2[013]|37|6[146]|80|9[17-9])|3(?:4[1235]|5[138]|76|8[1578])', '2(?:2[013]|37|6[146]|80|9[17-9])|3(?:4[1235]|5(?:[18]|3[0-35689])|76|8(?:[15]|7[0-24-9]|8[0-79]))'], national_prefix_formatting_rule=u'0\\1'),
    ...
    intl_number_format=[NumberFormat(pattern='([68]\\d{2})(\\d{3})(\\d{4})', format=u'\\1-\\2-\\3', leading_digits_pattern=['[68]']),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{4})', format=u'\\1 \\2-\\3', leading_digits_pattern=['2(?:2[013]|37|6[146]|80|9[17-9])|3(?:4[1235]|5[138]|76|8[1578])', '2(?:2[013]|37|6[146]|80|9[17-9])|3(?:4[1235]|5(?:[18]|3[0-35689])|76|8(?:[15]|7[0-24-9]|8[0-79]))']),
