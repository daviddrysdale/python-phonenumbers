...
PHONE_METADATA_AS = PhoneMetadata(id='AS', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='6846(?:22|33|44|55|77|88|9[19])\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='6846221234', possible_length=(10,), possible_length_local_only=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='684(?:2(?:5[2468]|72)|7(?:3[13]|70))\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='6847331234', possible_length=(10,), possible_length_local_only=(7,)),
