...
PHONE_METADATA_AW = PhoneMetadata(id='AW', country_code=297, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='5(?:2\\d|8[1-9])\\d{4}', possible_number_pattern='\\d{7}', example_number='5212345', possible_length=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:5(?:6\\d|9[2-478])|6(?:[039]0|22|4[01]|6[0-2])|7[34]\\d|9(?:6[45]|9[4-8]))\\d{4}', possible_number_pattern='\\d{7}', example_number='5601234', possible_length=(7,)),
