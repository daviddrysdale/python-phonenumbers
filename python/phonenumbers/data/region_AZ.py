...
PHONE_METADATA_AZ = PhoneMetadata(id='AZ', country_code=994, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1[28]\\d{3}|2(?:02|1[24]|2[2-4]|33|[45]2|6[23])\\d{2}|365(?:[0-46-9]\\d|5[0-35-9]))\\d{4}', possible_number_pattern='\\d{7,9}', example_number='123123456'),
    mobile=PhoneNumberDesc(national_number_pattern='(?:36554|(?:4[04]|5[015]|60|7[07])\\d{3})\\d{4}', possible_number_pattern='\\d{9}', example_number='401234567'),
