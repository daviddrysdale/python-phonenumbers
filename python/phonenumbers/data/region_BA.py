...
PHONE_METADATA_BA = PhoneMetadata(id='BA', country_code=387, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{3})(\\d{3})', format=u'\\1 \\2-\\3', leading_digits_pattern=['[3-5]'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(\\d{2})(\\d{3})(\\d{3})', format=u'\\1 \\2 \\3', leading_digits_pattern=['6[1-356]|[7-9]'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(\\d{2})(\\d{2})(\\d{2})(\\d{3})', format=u'\\1 \\2 \\3 \\4', leading_digits_pattern=['6[047]'], national_prefix_formatting_rule=u'0\\1')])
