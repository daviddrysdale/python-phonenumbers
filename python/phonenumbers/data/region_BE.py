...
PHONE_METADATA_BE = PhoneMetadata(id='BE', country_code=32, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern=u'[1-9]\d{7,8}', possible_number_pattern=u'\d{8,9}'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'(?:1[0-69]|[23][2-8]|[49][23]|5\d|6[013-57-9]|7[18])\d{6}|8(?:0[1-9]|[1-69]\d)\d{5}', possible_number_pattern=u'\d{8}', example_number=u'12345678'),
    mobile=PhoneNumberDesc(national_number_pattern=u'4(?:7\d|8[4-9]|9[1-9])\d{6}', possible_number_pattern=u'\d{9}', example_number=u'470123456'),
    toll_free=PhoneNumberDesc(national_number_pattern=u'800\d{5}', possible_number_pattern=u'\d{8}', example_number=u'80012345'),
    premium_rate=PhoneNumberDesc(national_number_pattern=u'(?:90|7[07])\d{6}', possible_number_pattern=u'\d{8}', example_number=u'90123456'),
    ...
    number_format=[NumberFormat(pattern='(4[7-9]\d)(\d{2})(\d{2})(\d{2})', format=u'\\1 \\2 \\3 \\4', leading_digits_pattern=['4[7-9]'], national_prefix_formatting_rule=u'0\\1'),
