...
PHONE_METADATA_BE = PhoneMetadata(id='BE', country_code=32, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:(?:1[0-69]|[23][2-8]|4[23]|5\\d|6[013-57-9]|71|9[2-4])\\d|8(?:0[2-8]|[1-79]\\d))\\d{5}', example_number='12345678', possible_length=(8,)),
    ...
    number_format=[NumberFormat(pattern='(\\d{3,4})', format='\\1', leading_digits_pattern=['1(?:0[0-8]|1[027]|2[0139]|3[019]|4[0159]|5[1569]|6[136]|[78])|[2-9]']),
        NumberFormat(pattern='(\\d{6})', format='\\1', leading_digits_pattern=['116', '116[01]', '116(?:00|11)', '116(?:000|117)']),
        ...
        NumberFormat(pattern='(\\d{2})(\\d{2})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['[15-7]|8(?:0[2-8]|[1-79])'], national_prefix_formatting_rule='0\\1'),
    ...
    intl_number_format=[NumberFormat(pattern='(\\d)(\\d{3})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['[23]|4[23]|9[2-4]']),
        NumberFormat(pattern='(\\d{2})(\\d{2})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['[15-7]|8(?:0[2-8]|[1-79])']),
        NumberFormat(pattern='(\\d{3})(\\d{2})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['[89]']),
        NumberFormat(pattern='(\\d{3})(\\d{2})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['4'])],
