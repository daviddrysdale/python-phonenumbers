...
PHONE_METADATA_BF = PhoneMetadata(id='BF', country_code=226, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern=u'7(?:[024-6]\d|1[0-489]|3[0124]|7[01]|8[013-9]|9[0-4])\d{5}', possible_number_pattern=u'\d{8}', example_number=u'70123456'),
