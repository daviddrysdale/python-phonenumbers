...
PHONE_METADATA_BF = PhoneMetadata(id='BF', country_code=226, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:6(?:0\\d|1[01]|6[0-4]|8[0-2])|7(?:[02-68]\\d|1[0-4689]|7[0-69]|9[0-689]))\\d{5}', possible_number_pattern='\\d{8}', example_number='70123456'),
