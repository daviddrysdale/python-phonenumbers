...
PHONE_METADATA_BH = PhoneMetadata(id='BH', country_code=973, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:3(?:[1-4679]\\d|5[0135]|8[0-48])\\d|6(?:3(?:00|33|6[16])|6(?:[69]\\d|3[03-9])))\\d{4}', possible_number_pattern='\\d{8}', example_number='36001234'),
