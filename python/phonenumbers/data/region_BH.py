...
PHONE_METADATA_BH = PhoneMetadata(id='BH', country_code=973, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:3(?:[23469]\\d|5[035]|77|8[348])\\d|6(?:1[16]\\d|3(?:00|33|6[16])|6(?:[069]\\d|3[03-9]|44)|9(?:69|9[6-9]))|77\\d{2})\\d{4}', possible_number_pattern='\\d{8}', example_number='36001234'),
