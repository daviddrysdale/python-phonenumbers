...
PHONE_METADATA_BJ = PhoneMetadata(id='BJ', country_code=229, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2090\\d{4}|2(?:02|1[037]|2[45]|3[68]|4\\d)\\d{5}', example_number='20211234', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:4[0-8]|[56]\\d|9[013-9])\\d{6}', example_number='90011234', possible_length=(8,)),
