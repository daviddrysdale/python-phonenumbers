...
PHONE_METADATA_BM = PhoneMetadata(id='BM', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='441(?:2(?:02|23|61|[3479]\\d)|[46]\\d{2}|5(?:4\\d|60|89)|824)\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='4412345678', possible_length=(10,), possible_length_local_only=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='441(?:[37]\\d|5[0-39])\\d{5}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='4413701234', possible_length=(10,), possible_length_local_only=(7,)),
