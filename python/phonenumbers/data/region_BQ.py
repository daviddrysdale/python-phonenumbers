...
PHONE_METADATA_BQ = PhoneMetadata(id='BQ', country_code=599, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:318[023]|416[0239]|7(?:1[578]|50)\\d)\\d{3}', possible_number_pattern='\\d{7}', example_number='7151234'),
    mobile=PhoneNumberDesc(national_number_pattern='(?:318[1456]|416[15-8]|7(?:0[01]|[89]\\d)\\d)\\d{3}|', possible_number_pattern='\\d{7}', example_number='3181234'),
