...
PHONE_METADATA_BR = PhoneMetadata(id='BR', country_code=55, international_prefix='00(?:1[45]|2[135]|[34]1|43)',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:[14689][1-9]|2[12478]|3[1-578]|5[13-5]|7[13-579])[2-5]\\d{7}', possible_number_pattern='\\d{8,10}', example_number='1123456789'),
    mobile=PhoneNumberDesc(national_number_pattern='(?:[14689][1-9]|2[12478]|3[1-578]|5[13-5]|7[13-579])[6-9]\\d{7}', possible_number_pattern='\\d{10}', example_number='1161234567'),
    ...
    shared_cost=PhoneNumberDesc(national_number_pattern='(?:400\\d|3003)\\d{4}', possible_number_pattern='\\d{8,10}', example_number='40041234'),
