...
PHONE_METADATA_BR = PhoneMetadata(id='BR', country_code=55, international_prefix='00(?:1[245]|2[1-35]|31|4[13]|[56]5|99)',
    general_desc=PhoneNumberDesc(national_number_pattern='[1-9]\\d{7,10}', possible_number_pattern='\\d{8,11}'),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:[1689][1-9]|2[12478]|3[1-578]|7[13-579])(?:7|9\\d)\\d{7}|(?:4[1-9]|5[13-5])(?:[6-8]|9\\d?)\\d{7}', possible_number_pattern='\\d{10,11}', example_number='11961234567'),
    ...
    intl_number_format=[NumberFormat(pattern='(\\d{2})(\\d{5})(\\d{4})', format='\\1 \\2-\\3', leading_digits_pattern=['(?:[14689][1-9]|2[12478]|3[1-578]|5[13-5]|7[13-579])9']),
