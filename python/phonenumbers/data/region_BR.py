...
PHONE_METADATA_BR = PhoneMetadata(id='BR', country_code=55, international_prefix='00(?:1[45]|2[135]|[34]1|43)',
    ...
    shared_cost=PhoneNumberDesc(national_number_pattern='(?:400\\d|3003)\\d{4}', possible_number_pattern='\\d{8}', example_number='40041234'),
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{4})(\\d{4})', format='\\1 \\2-\\3', leading_digits_pattern=['[1-9][1-9]'], national_prefix_formatting_rule='(\\1)', domestic_carrier_code_formatting_rule='0 $CC (\\1)'),
        NumberFormat(pattern='([34]00\\d)(\\d{4})', format='\\1-\\2', leading_digits_pattern=['[34]00', '400|3003']),
