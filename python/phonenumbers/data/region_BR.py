...
PHONE_METADATA_BR = PhoneMetadata(id='BR', country_code=55, international_prefix='00(?:1[45]|2[135]|31|4[13])',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:1[1-9]|2[12478]|[89][1-9])(?:7|9\\d)\\d{7}|(?:3[1-578]|7[13-579])9?[6-9]\\d{7}|(?:[46][1-9]|5[1-5])[6-9]\\d{7}', possible_number_pattern='\\d{10,11}', example_number='11961234567'),
