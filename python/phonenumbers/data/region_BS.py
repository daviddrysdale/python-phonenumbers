...
PHONE_METADATA_BS = PhoneMetadata(id='BS', country_code=1, international_prefix='011',
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='(?:242300|8(?:00|33|44|55|66|77|88)[2-9]\\d\\d)\\d{4}', example_number='8002123456', possible_length=(10,), possible_length_local_only=(7,)),
