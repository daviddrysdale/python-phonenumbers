...
PHONE_METADATA_BT = PhoneMetadata(id='BT', country_code=975, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:17|[2-8])\\d{6}', possible_number_pattern='\\d{6,8}'),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='17\\d{6}', possible_number_pattern='\\d{8}', example_number='17123456'),
