...
PHONE_METADATA_BW = PhoneMetadata(id='BW', country_code=267, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='90\\d{5}|(?:0800|[2-6]|7\\d)\\d{6}', possible_length=(7, 8, 10)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='77200\\d{3}|7(?:[1-6]\\d|7[013-9])\\d{5}', example_number='71123456', possible_length=(8,)),
    toll_free=PhoneNumberDesc(national_number_pattern='0800\\d{6}', example_number='0800012345', possible_length=(10,)),
