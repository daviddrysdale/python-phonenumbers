...
PHONE_METADATA_BW = PhoneMetadata(id='BW', country_code=267, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern=u'[2-79]\d{6,7}', possible_number_pattern=u'\d{7,8}'),
    ...
    mobile=PhoneNumberDesc(national_number_pattern=u'7(?:[1-35]\d{6}|[46][0-7]\d{5})', possible_number_pattern=u'\d{8}', example_number=u'71123456'),
    ...
    voip=PhoneNumberDesc(national_number_pattern=u'79[12][01]\d{4}', possible_number_pattern=u'\d{8}', example_number=u'79101234'),
