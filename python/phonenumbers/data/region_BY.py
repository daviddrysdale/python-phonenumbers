...
PHONE_METADATA_BY = PhoneMetadata(id='BY', country_code=375, international_prefix='810',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:(?:[12]|8[0-7]\\d)\\d|33|44|902)\\d{7}|8(?:[05-79]\\d|1[0-489])\\d{7}|8[0-79]\\d{5,7}|8\\d{5}', possible_length=(6, 7, 8, 9, 10, 11), possible_length_local_only=(5, 6, 7)),
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='8(?:0[013]|20\\d)\\d{7}|800\\d{3,6}', example_number='8011234567', possible_length=(6, 7, 8, 9, 10, 11)),
    ...
    no_international_dialling=PhoneNumberDesc(national_number_pattern='(?:8(?:0[013]|10|20\\d)|902)\\d{7}|800\\d{3,6}', possible_length=(6, 7, 8, 9, 10, 11)),
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{3})', format='\\1 \\2', leading_digits_pattern=['800'], national_prefix_formatting_rule='8 \\1'),
        ...
        NumberFormat(pattern='(\\d{4})(\\d{2})(\\d{3})', format='\\1 \\2-\\3', leading_digits_pattern=['1(?:[56]|7[179])|2[1-3]', '1(?:[56]|7(?:1[3-9]|7|9[2-7]))|2[1-3]'], national_prefix_formatting_rule='8 0\\1'),
