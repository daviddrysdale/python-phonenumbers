...
PHONE_METADATA_CD = PhoneMetadata(id='CD', country_code=243, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='([89]\\d{2})(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['[89]'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='([1-6]\\d)(\\d{5})', format='\\1 \\2', leading_digits_pattern=['[1-6]'], national_prefix_formatting_rule='0\\1')])
