...
PHONE_METADATA_CF = PhoneMetadata(id='CF', country_code=236, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2[12]\\d{6}', possible_number_pattern='\\d{8}', example_number='21612345', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='7[0257]\\d{6}', possible_number_pattern='\\d{8}', example_number='70012345', possible_length=(8,)),
