...
PHONE_METADATA_CG = PhoneMetadata(id='CG', country_code=242, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:(?:0\\d|80)\\d|222)\\d{6}', possible_length=(9,)),
    ...
    premium_rate=PhoneNumberDesc(national_number_pattern='80(?:0\\d{2}|11[0-4])\\d{4}', example_number='800123456', possible_length=(9,)),
