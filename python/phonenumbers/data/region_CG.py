...
PHONE_METADATA_CG = PhoneMetadata(id='CG', country_code=242, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern=u'[028]\d{8}', possible_number_pattern=u'\d{9}'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'222[1-589]\d{5}', possible_number_pattern=u'\d{9}', example_number=u'222123456'),
    mobile=PhoneNumberDesc(national_number_pattern=u'0[14-6]\d{7}', possible_number_pattern=u'\d{9}', example_number=u'061234567'),
