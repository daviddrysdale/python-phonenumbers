...
PHONE_METADATA_CI = PhoneMetadata(id='CI', country_code=225, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[02-5]\\d{7}', possible_number_pattern='\\d{8}'),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:0[1-9]|4[04-9]|5[07]|6[067])\\d{6}', possible_number_pattern='\\d{8}', example_number='01234567'),
