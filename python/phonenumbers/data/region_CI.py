...
PHONE_METADATA_CI = PhoneMetadata(id='CI', country_code=225, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[02-7]\\d{7}', possible_number_pattern='\\d{8}'),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:0[1-9]|4[0-24-9]|5[4-9]|6[015-79]|7[578])\\d{6}', possible_number_pattern='\\d{8}', example_number='01234567'),
