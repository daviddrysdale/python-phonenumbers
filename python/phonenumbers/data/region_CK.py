...
PHONE_METADATA_CK = PhoneMetadata(id='CK', country_code=682, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:2\\d|3[13-7]|4[1-5])\\d{3}', possible_number_pattern='\\d{5}', example_number='21234', possible_length=(5,)),
    mobile=PhoneNumberDesc(national_number_pattern='[5-8]\\d{4}', possible_number_pattern='\\d{5}', example_number='71234', possible_length=(5,)),
