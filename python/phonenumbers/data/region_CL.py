...
PHONE_METADATA_CL = PhoneMetadata(id='CL', country_code=56, international_prefix='(?:0|1(?:1[0-69]|2[0-57]|5[13-58]|69|7[0167]|8[018]))0',
    general_desc=PhoneNumberDesc(national_number_pattern=u'(?:[2-9]|600|123)\d{7,8}', possible_number_pattern=u'\d{6,11}'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'(?:2|32|41)\d{7}|(?:3[3-5]|4[235]|5[1-3578]|6[13-57]|7[1-35])\d{6,7}', possible_number_pattern=u'\d{6,9}', example_number=u'21234567'),
    mobile=PhoneNumberDesc(national_number_pattern=u'9[6-9]\d{7}', possible_number_pattern=u'\d{8,9}', example_number=u'961234567'),
    toll_free=PhoneNumberDesc(national_number_pattern=u'800\d{6}|1230\d{7}', possible_number_pattern=u'\d{9,11}', example_number=u'800123456'),
    premium_rate=PhoneNumberDesc(national_number_pattern=u'600\d{7,8}', possible_number_pattern=u'\d{10,11}', example_number=u'6001234567'),
    shared_cost=PhoneNumberDesc(national_number_pattern=u'NA', possible_number_pattern=u'NA'),
    personal_number=PhoneNumberDesc(national_number_pattern=u'NA', possible_number_pattern=u'NA'),
    voip=PhoneNumberDesc(national_number_pattern=u'44\d{7}', possible_number_pattern=u'\d{9}', example_number=u'441234567'),
