...
PHONE_METADATA_CM = PhoneMetadata(id='CM', country_code=237, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2(?:22|33|4[23])\\d{6}|(?:22|33)\\d{6}', possible_number_pattern='\\d{8,9}', example_number='222123456'),
    mobile=PhoneNumberDesc(national_number_pattern='6[5-79]\\d{7}|[579]\\d{7}', possible_number_pattern='\\d{8,9}', example_number='671234567'),
    ...
    number_format=[NumberFormat(pattern='([26])(\\d{2})(\\d{2})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4 \\5', leading_digits_pattern=['[26]']),
        NumberFormat(pattern='([2357-9]\\d)(\\d{2})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['[23579]|88']),
