...
PHONE_METADATA_CM = PhoneMetadata(id='CM', country_code=237, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='[579]\\d{7}', possible_number_pattern='\\d{8}', example_number='71234567'),
    ...
    number_format=[NumberFormat(pattern='([2357-9]\\d)(\\d{2})(\\d{2})(\\d{2})', format=u'\\1 \\2 \\3 \\4', leading_digits_pattern=['[23579]|88']),
