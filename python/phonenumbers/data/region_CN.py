...
PHONE_METADATA_CN = PhoneMetadata(id='CN', country_code=86, international_prefix='(?:1(?:[12]\\d{3}|79\\d{2}|9[0-7]\\d{2}))?00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='1(?:[38]\\d{3}|4[57]\\d{2}|5[0-35-9]\\d{2}|6[25-7]\\d{2}|7(?:[0-35-8]\\d{2}|40[0-5])|9[189]\\d{2})\\d{6}', example_number='13123456789', possible_length=(11,)),
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['[48]00']),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{4})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['1(?:[3-57-9]|6[25-7])'], domestic_carrier_code_formatting_rule='$CC \\1'),
    ...
    intl_number_format=[NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['[48]00']),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{4})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['1(?:[3-57-9]|6[25-7])']),
        NumberFormat(pattern='(\\d{5})(\\d{3})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['108', '1080', '10800']),
        NumberFormat(pattern='(\\d{3})(\\d{7,8})', format='\\1 \\2', leading_digits_pattern=['950'])])
