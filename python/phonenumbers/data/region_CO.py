...
PHONE_METADATA_CO = PhoneMetadata(id='CO', country_code=57, international_prefix='00(?:4(?:[14]4|56)|[579])',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:1\\d|[36])\\d{9}|[124-8]\\d{7}', possible_length=(8, 10, 11), possible_length_local_only=(7,)),
    fixed_line=PhoneNumberDesc(national_number_pattern='60[124-8][2-9]\\d{6}|[124-8][2-9]\\d{6}', example_number='6012345678', possible_length=(8, 10), possible_length_local_only=(7,)),
