...
PHONE_METADATA_CR = PhoneMetadata(id='CR', country_code=506, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='5(?:0[01]|7[0-3])\\d{5}|6(?:[0-2]\\d|30)\\d{5}|7[0-3]\\d{6}|8[3-9]\\d{6}', possible_number_pattern='\\d{8}', example_number='83123456'),
