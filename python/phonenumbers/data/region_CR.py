...
PHONE_METADATA_CR = PhoneMetadata(id='CR', country_code=506, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='57[0-3]\\d{5}|6(?:[0-2]\\d|30)\\d{5}|7[0-3]\\d{6}|8[3-9]\\d{6}', possible_number_pattern='\\d{8}', example_number='83123456'),
    ...
    voip=PhoneNumberDesc(national_number_pattern='210[0-6]\\d{4}|4(?:0(?:0[01]\\d{4}|10[0-3]\\d{3}|2900\\d{2}|3[01]\\d{4}|40\\d{4}|5\\d{5}|70[01]\\d{3}|8[0-2]\\d{4})|1[01]\\d{5}|20[0-3]\\d{4}|400\\d{4}|70[0-2]\\d{4})|5100\\d{4}', possible_number_pattern='\\d{8}', example_number='40001234'),
