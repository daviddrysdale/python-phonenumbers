...
PHONE_METADATA_CR = PhoneMetadata(id='CR', country_code=506, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[24-9]\\d{7,9}', possible_number_pattern='\\d{8,10}', possible_length=(8, 10)),
    fixed_line=PhoneNumberDesc(national_number_pattern='2[0-24-7]\\d{6}', possible_number_pattern='\\d{8}', example_number='22123456', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='5(?:0[01]|7[0-3])\\d{5}|(?:[67][0-3]|8[3-9])\\d{6}', possible_number_pattern='\\d{8}', example_number='83123456', possible_length=(8,)),
