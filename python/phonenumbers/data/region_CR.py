...
PHONE_METADATA_CR = PhoneMetadata(id='CR', country_code=506, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2(?:[024-7]\\d\\d|1(?:0[7-9]|[1-9]\\d))\\d{4}', example_number='22123456', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:(?:5(?:0[01]|7[0-3])|(?:7[0-3]|8[3-9])\\d)\\d\\d|6(?:[0-4]\\d{3}|500[01]))\\d{3}', example_number='83123456', possible_length=(8,)),
