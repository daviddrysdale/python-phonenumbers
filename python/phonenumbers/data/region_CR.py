...
PHONE_METADATA_CR = PhoneMetadata(id='CR', country_code=506, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='57[01]\\d[01]\\d{3}|8[36789]\\d{6}', possible_number_pattern='\\d{8}', example_number='83123456'),
    ...
    national_prefix_for_parsing='(1900)',
