...
PHONE_METADATA_CR = PhoneMetadata(id='CR', country_code=506, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern=u'8[389]\d{6}', possible_number_pattern=u'\d{8}', example_number=u'83123456'),
    ...
    number_format=[NumberFormat(pattern='(\d{4})(\d{4})', format=u'\\1 \\2', leading_digits_pattern=['[24]|8[389]'], domestic_carrier_code_formatting_rule=u'$CC \\1'),
