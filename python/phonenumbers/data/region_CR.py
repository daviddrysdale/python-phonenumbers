...
PHONE_METADATA_CR = PhoneMetadata(id='CR', country_code=506, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[24589]\\d{7,9}', possible_number_pattern='\\d{8,10}'),
    fixed_line=PhoneNumberDesc(national_number_pattern='2[24-7]\\d{6}', possible_number_pattern='\\d{8}', example_number='22123456'),
    mobile=PhoneNumberDesc(national_number_pattern='5(?:0[0-4]\\d{5}|7[01]\\d[01]\\d{3})|8[36-9]\\d{6}', possible_number_pattern='\\d{8}', example_number='83123456'),
    ...
    voip=PhoneNumberDesc(national_number_pattern='40(?:00\\d{4}|10[0-3]\\d{3}|2(?:00\\d|900)\\d{2}|5\\d{5})', possible_number_pattern='\\d{8}', example_number='40001234'),
