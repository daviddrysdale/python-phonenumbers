...
PHONE_METADATA_CU = PhoneMetadata(id='CU', country_code=53, international_prefix='119',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:3[23]|48)\\d{4,6}|(?:31|4[36])\\d{6}|(?:2[1-4]|4[1257]|7\\d)\\d{5,6}', example_number='71234567', possible_length=(6, 7, 8), possible_length_local_only=(4, 5)),
