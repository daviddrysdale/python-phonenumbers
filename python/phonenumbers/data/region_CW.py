...
PHONE_METADATA_CW = PhoneMetadata(id='CW', country_code=599, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[169]\\d{6,7}', possible_number_pattern='\\d{7,8}', possible_length=[8,7]),
    fixed_line=PhoneNumberDesc(national_number_pattern='9(?:[48]\\d{2}|50\\d|7(?:2[0-24]|[34]\\d|6[35-7]|77|8[7-9]))\\d{4}', possible_number_pattern='\\d{7,8}', example_number='94151234', possible_length=[8]),
    mobile=PhoneNumberDesc(national_number_pattern='9(?:5(?:[12467]\\d|3[01])|6(?:[15-9]\\d|3[01]))\\d{4}', possible_number_pattern='\\d{7,8}', example_number='95181234', possible_length=[8]),
