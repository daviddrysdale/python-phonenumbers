...
PHONE_METADATA_CX = PhoneMetadata(id='CX', country_code=61, international_prefix='(?:14(?:1[14]|34|4[17]|[56]6|7[47]|88))?001[14-689]',
    general_desc=PhoneNumberDesc(national_number_pattern='[1458]\\d{5,9}', possible_number_pattern='\\d{6,10}', possible_length=[8,9,10,6,7], possible_length_local_only=[8]),
