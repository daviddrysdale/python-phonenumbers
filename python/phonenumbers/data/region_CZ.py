...
PHONE_METADATA_CZ = PhoneMetadata(id='CZ', country_code=420, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='60[1-8]\\d{6}|7[2379]\\d{7}', possible_number_pattern='\\d{9}', example_number='601123456'),
    toll_free=PhoneNumberDesc(national_number_pattern='800\\d{6}', possible_number_pattern='\\d{9}', example_number='800123456'),
    premium_rate=PhoneNumberDesc(national_number_pattern='90[0689]\\d{6}', possible_number_pattern='\\d{9}', example_number='900123456'),
