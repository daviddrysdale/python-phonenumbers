...
PHONE_METADATA_DE = PhoneMetadata(id='DE', country_code=49, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern=u'[1-35-9]\d{3,13}|4(?:[0-8]\d{4,12}|9(?:4[1-8]|[0-35-7]\d)\d{2,7})', possible_number_pattern=u'\d{2,14}'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'[246]\d{5,13}|3(?:[03-9]\d{4,11}|2\d{9})|5(?:0[2-8]|[38][0-8]|[124-6]\d|[79][0-7])\d{3,10}|7(?:0[2-8]|[1-9]\d)\d{3,10}|8(?:0[2-9]|[1-9]\d)\d{3,10}|9(?:0[6-9]|[1-9]\d)\d{3,10}', possible_number_pattern=u'\d{2,14}', example_number=u'30123456'),
    mobile=PhoneNumberDesc(national_number_pattern=u'1(?:5\d{9}|7(?:[0-57-9]|6\d)\d{7}|6(?:[02]\d{7,8}|3\d{7}))', possible_number_pattern=u'\d{10,11}', example_number=u'15123456789'),
    toll_free=PhoneNumberDesc(national_number_pattern=u'800\d{7,9}', possible_number_pattern=u'\d{10,12}', example_number=u'8001234567'),
    premium_rate=PhoneNumberDesc(national_number_pattern=u'900(?:[135]\d{6}|9\d{7})', possible_number_pattern=u'\d{10,11}', example_number=u'9001234567'),
    shared_cost=PhoneNumberDesc(national_number_pattern=u'180\d{5,11}', possible_number_pattern=u'\d{8,14}', example_number=u'18012345'),
    personal_number=PhoneNumberDesc(national_number_pattern=u'700\d{8}', possible_number_pattern=u'\d{11}', example_number=u'70012345678'),
    voip=PhoneNumberDesc(national_number_pattern=u'NA', possible_number_pattern=u'NA'),
    pager=PhoneNumberDesc(national_number_pattern=u'16(?:4\d{1,10}|[89]\d{1,11})', possible_number_pattern=u'\d{4,14}', example_number=u'16412345'),
