...
PHONE_METADATA_DE = PhoneMetadata(id='DE', country_code=49, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='1(?:5[0-25-9]\\d{8}|6[023]\\d{7,8}|7\\d{8,9})', possible_number_pattern='\\d{10,11}', example_number='15123456789', possible_length=(10, 11)),
