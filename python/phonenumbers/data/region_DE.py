...
PHONE_METADATA_DE = PhoneMetadata(id='DE', country_code=49, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{4,11})', format='\\1 \\2', leading_digits_pattern=['3[02]|40|[68]9'], national_prefix_formatting_rule='0\\1'),
        ...
        NumberFormat(pattern='(\\d{5})(\\d{1,10})', format='\\1 \\2', leading_digits_pattern=['3'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(1\\d{2})(\\d{7,8})', format='\\1 \\2', leading_digits_pattern=['1[5-7]'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(177)(99)(\\d{7,8})', format='\\1 \\2 \\3', leading_digits_pattern=['177', '1779', '17799'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(8\\d{2})(\\d{7,10})', format='\\1 \\2', leading_digits_pattern=['800'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(\\d{3})(\\d)(\\d{4,10})', format='\\1 \\2 \\3', leading_digits_pattern=['(?:18|90)0', '180|900[1359]'], national_prefix_formatting_rule='0\\1'),
