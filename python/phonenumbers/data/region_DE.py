...
PHONE_METADATA_DE = PhoneMetadata(id='DE', country_code=49, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[1-35-9]\\d{3,14}|4(?:[0-8]\\d{4,12}|9(?:4[1-8]|6[1-8]\\d?|[0-357]\\d)\\d{2,7})', possible_number_pattern='\\d{2,15}'),
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{4,11})', format='\\1/\\2', leading_digits_pattern=['3[02]|40|[68]9'], national_prefix_formatting_rule='0\\1'),
        ...
        NumberFormat(pattern='([18]\\d{2})(\\d{7,10})', format='\\1 \\2', leading_digits_pattern=['1[5-7]|800'], national_prefix_formatting_rule='0\\1'),
        ...
        NumberFormat(pattern='(18\\d{3})(\\d{6})', format='\\1 \\2', leading_digits_pattern=['18500'], national_prefix_formatting_rule='0\\1'),
