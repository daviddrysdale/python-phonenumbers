...
PHONE_METADATA_DJ = PhoneMetadata(id='DJ', country_code=253, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2(?:1[2-5]|7[45])\\d{5}', possible_number_pattern='\\d{8}', example_number='21360003', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='77[0-26-8]\\d{5}', possible_number_pattern='\\d{8}', example_number='77831001', possible_length=(8,)),
