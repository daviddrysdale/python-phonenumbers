...
PHONE_METADATA_DK = PhoneMetadata(id='DK', country_code=45, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:[2-7]\\d|8[126-9]|9[16-9])\\d{6}', possible_number_pattern='\\d{8}', example_number='32123456'),
    mobile=PhoneNumberDesc(national_number_pattern='(?:[2-7]\\d|8[126-9]|9[16-9])\\d{6}', possible_number_pattern='\\d{8}', example_number='20123456'),
