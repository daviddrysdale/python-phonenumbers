...
PHONE_METADATA_DM = PhoneMetadata(id='DM', country_code=1, international_prefix='011',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='767(?:2(?:[2-4689]5|7[5-7])|31[5-7]|61[1-7]|70[1-6])\\d{4}', example_number='7672251234', possible_length=(10,), possible_length_local_only=(7,)),
