...
PHONE_METADATA_DO = PhoneMetadata(id='DO', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern=u'8[024]9[2-9]\d{6}', possible_number_pattern=u'\d{7}(?:\d{3})?', example_number=u'8092345678'),
    mobile=PhoneNumberDesc(national_number_pattern=u'8[024]9[2-9]\d{6}', possible_number_pattern=u'\d{7}(?:\d{3})?', example_number=u'8092345678'),
