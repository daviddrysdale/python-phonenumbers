...
PHONE_METADATA_DZ = PhoneMetadata(id='DZ', country_code=213, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:(?:1\\d|2[013-79]|3[0-8]|4[0135689])\\d|9619)\\d{5}', example_number='12345678', possible_length=(8, 9)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:(?:5[4-6]|7[7-9])\\d|6(?:[569]\\d|7[0-6]))\\d{6}', example_number='551234567', possible_length=(9,)),
