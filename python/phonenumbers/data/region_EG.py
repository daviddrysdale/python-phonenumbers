...
PHONE_METADATA_EG = PhoneMetadata(id='EG', country_code=20, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='1(?:0[01269]|1[1245]|2[0-278])\\d{7}', possible_number_pattern='\\d{10}', example_number='1001234567'),
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{7,8})', format=u'\\1 \\2', leading_digits_pattern=['[23]'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['1[012]|[89]00'], national_prefix_formatting_rule=u'0\\1'),
