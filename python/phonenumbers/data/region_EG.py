...
PHONE_METADATA_EG = PhoneMetadata(id='EG', country_code=20, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='1(?:[0-246-9]|5[0-2])\\d{7}', possible_number_pattern='\\d{9,10}', example_number='101234567'),
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{7,8})', format=u'\\1 \\2', leading_digits_pattern=['[23]'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['15[0-2]|[89]00'], national_prefix_formatting_rule=u'0\\1'),
