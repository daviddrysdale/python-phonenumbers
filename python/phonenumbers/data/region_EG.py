...
PHONE_METADATA_EG = PhoneMetadata(id='EG', country_code=20, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{7,8})', format='\\1 \\2', leading_digits_pattern=['[23]'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['1(?:0[0169]|1[124]|2[0-278]|5[0-2])|[89]00'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(\\d{2})(\\d{3})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['1(?:[0-246-9]|5[3-9])'], national_prefix_formatting_rule='0\\1'),
