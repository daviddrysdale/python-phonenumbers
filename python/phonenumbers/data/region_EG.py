...
PHONE_METADATA_EG = PhoneMetadata(id='EG', country_code=20, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1(3[23]\\d|5[23])|2[2-4]\\d{2}|3\\d{2}|4(?:0[2-5]|[578][23]|64)\\d|5(?:0[2-7]|[57][23])\\d|6[24-689]3\\d|8(?:2[2-57]|4[26]|6[237]|8[2-4])\\d|9(?:2[27]|3[24]|52|6[2356]|7[2-4])\\d)\\d{5}|1[69]\\d{3}', possible_number_pattern='\\d{5,9}', example_number='234567890'),
    mobile=PhoneNumberDesc(national_number_pattern='1(?:[0-246-9]|5[0-2])\\d{7}|1(?:0[0169]|1[124]|2[0-278])\\d{7}', possible_number_pattern='\\d{9,10}', example_number='1001234567'),
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{7,8})', format=u'\\1 \\2', leading_digits_pattern=['[23]'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['1(?:0[0169]|1[124]|2[0-278]|5[0-2])|[89]00'], national_prefix_formatting_rule=u'0\\1'),
        ...
        NumberFormat(pattern='(\\d{2})(\\d{6,7})', format=u'\\1 \\2', leading_digits_pattern=['1(?:3|5[23])|[4-6]|[89][2-9]'], national_prefix_formatting_rule=u'0\\1')])
