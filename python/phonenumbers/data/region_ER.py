...
PHONE_METADATA_ER = PhoneMetadata(id='ER', country_code=291, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='1(?:1[12568]|20|40|55|6[146])\\d{4}|8\\d{6}', possible_number_pattern='\\d{6,7}', example_number='8370362', possible_length=(7,), possible_length_local_only=(6,)),
