...
PHONE_METADATA_ES = PhoneMetadata(id='ES', country_code=34, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='[89][1-8]\\d{7}', possible_number_pattern='\\d{9}', example_number='812345678'),
    mobile=PhoneNumberDesc(national_number_pattern='6\\d{8}', possible_number_pattern='\\d{9}', example_number='612345678'),
