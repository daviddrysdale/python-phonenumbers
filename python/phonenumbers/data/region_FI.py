...
PHONE_METADATA_FI = PhoneMetadata(id='FI', country_code=358, international_prefix='00|99(?:[02469]|5(?:11|33|5[59]|88|9[09]))',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='1(?:[3569][1-8]\\d{3,9}|[47]\\d{5,10})|2[1-8]\\d{3,9}|3(?:[1-8]\\d{3,9}|9\\d{4,8})|[5689][1-8]\\d{3,9}', possible_number_pattern='\\d{5,12}', example_number='1312345678', possible_length=(5, 6, 7, 8, 9, 10, 11, 12)),
