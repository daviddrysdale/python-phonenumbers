...
PHONE_METADATA_FI = PhoneMetadata(id='FI', country_code=358, international_prefix='00|99[049]',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='1(?:[35689][1-8]\\d{3,9}|[47]\\d{5,10})|2[1-8]\\d{3,9}|3(?:[1-8]\\d{3,9}|9\\d{4,8})|[5689][1-8]\\d{3,9}|', possible_number_pattern='\\d{5,12}', example_number='1312345678'),
    ...
    uan=PhoneNumberDesc(national_number_pattern='10[1-9]\\d{3,7}|2(?:0(?:[16-8]\\d{3,7}|2[14-9]\\d{1,6}|[3-5]\\d{2,7}|9[0-7]\\d{1,6})|9\\d{4,8})|30[1-9]\\d{3,7}|7(?:1\\d{7}|3\\d{8}|5[03-9]\\d{2,7})', possible_number_pattern='\\d{6,10}', example_number='10112345'),
