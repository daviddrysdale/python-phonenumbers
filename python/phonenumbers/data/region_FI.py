...
PHONE_METADATA_FI = PhoneMetadata(id='FI', country_code=358, international_prefix='00|99(?:[02469]|5(?:11|33|5[59]|88|9[09]))',
    general_desc=PhoneNumberDesc(national_number_pattern='[156]\\d{6,9}|2\\d{4,9}|3\\d{5,9}|4\\d{7,10}|7\\d{7,9}|[89]\\d{6,8}', possible_length=(5, 6, 7, 8, 9, 10, 11)),
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{3,7})', format='\\1 \\2', leading_digits_pattern=['(?:[16-8]0|300)'], national_prefix_formatting_rule='0\\1'),
        ...
        NumberFormat(pattern='(\\d)(\\d{6,9})', format='\\1 \\2', leading_digits_pattern=['[25689][1-8]|3(?:0[1-9]|[1-8])'], national_prefix_formatting_rule='0\\1'),
    ...
    intl_number_format=[NumberFormat(pattern='(\\d{3})(\\d{3,7})', format='\\1 \\2', leading_digits_pattern=['(?:[16-8]0|300)']),
        ...
        NumberFormat(pattern='(\\d)(\\d{6,9})', format='\\1 \\2', leading_digits_pattern=['[25689][1-8]|3(?:0[1-9]|[1-8])']),
