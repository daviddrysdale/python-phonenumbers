...
PHONE_METADATA_FI = PhoneMetadata(id='FI', country_code=358, international_prefix='00|99[049]',
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{4,10})', format='\\1 \\2', leading_digits_pattern=['2[09]|[14]|50|7[135]'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(\\d)(\\d{4,11})', format='\\1 \\2', leading_digits_pattern=['[25689][1-8]|3'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='([6-8]00)(\\d{4,7})', format='\\1 \\2', leading_digits_pattern=['[6-8]0'], national_prefix_formatting_rule='0\\1')],
