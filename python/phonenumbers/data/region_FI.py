...
PHONE_METADATA_FI = PhoneMetadata(id='FI', country_code=358, international_prefix='00|99(?:[02469]|5(?:11|33|5[59]|88|9[09]))',
    general_desc=PhoneNumberDesc(national_number_pattern='[16]\\d{6,9}|2\\d{4,9}|[35]\\d{5,9}|4\\d{7,10}|7\\d{7,9}|8\\d{6,8}|9\\d{4,8}', possible_length=(5, 6, 7, 8, 9, 10, 11)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='4[0-8]\\d{6,8}|50\\d{4,8}', example_number='412345678', possible_length=(6, 7, 8, 9, 10, 11)),
