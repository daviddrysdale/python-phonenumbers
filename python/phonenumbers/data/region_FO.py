...
PHONE_METADATA_FO = PhoneMetadata(id='FO', country_code=298, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:20|[3-4]\\d|8[19])\\d{4}', possible_number_pattern='\\d{6}', example_number='201234', possible_length=(6,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:[27][1-9]|5\\d)\\d{4}', possible_number_pattern='\\d{6}', example_number='211234', possible_length=(6,)),
