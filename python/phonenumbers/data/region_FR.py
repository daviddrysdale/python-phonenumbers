...
PHONE_METADATA_FR = PhoneMetadata(id='FR', country_code=33, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='([1-79])(\\d{2})(\\d{2})(\\d{2})(\\d{2})', format=u'\\1 \\2 \\3 \\4 \\5', leading_digits_pattern=['[1-79]'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(1\\d{2})(\\d{3})', format=u'\\1 \\2', leading_digits_pattern=['11'], national_prefix_formatting_rule=u'\\1'),
        NumberFormat(pattern='(8\\d{2})(\\d{2})(\\d{2})(\\d{2})', format=u'\\1 \\2 \\3 \\4', leading_digits_pattern=['8'], national_prefix_formatting_rule=u'0 \\1')],
    intl_number_format=[NumberFormat(pattern='([1-79])(\\d{2})(\\d{2})(\\d{2})(\\d{2})', format=u'\\1 \\2 \\3 \\4 \\5', leading_digits_pattern=['[1-79]']),
        NumberFormat(pattern='(8\\d{2})(\\d{2})(\\d{2})(\\d{2})', format=u'\\1 \\2 \\3 \\4', leading_digits_pattern=['8'])])
