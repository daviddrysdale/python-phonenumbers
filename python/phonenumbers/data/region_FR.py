...
PHONE_METADATA_FR = PhoneMetadata(id='FR', country_code=33, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='[1-5]\\d{8}', possible_number_pattern='\\d{9}', example_number='123456789', possible_length=(9,)),
    mobile=PhoneNumberDesc(national_number_pattern='6\\d{8}|7(?:00\\d{6}|[3-9]\\d{7})', possible_number_pattern='\\d{9}', example_number='612345678', possible_length=(9,)),
