...
PHONE_METADATA_FR = PhoneMetadata(id='FR', country_code=33, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:6\\d\\d|7(?:00|[3-9]\\d))\\d{6}', example_number='612345678', possible_length=(9,)),
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{3})', format='\\1 \\2', leading_digits_pattern=['11']),
    ...
    intl_number_format=[NumberFormat(pattern='(\\d)(\\d{2})(\\d{2})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4 \\5', leading_digits_pattern=['[1-79]']),
