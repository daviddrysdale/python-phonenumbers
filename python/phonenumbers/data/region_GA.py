...
PHONE_METADATA_GA = PhoneMetadata(id='GA', country_code=241, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:0[2-7]|6[256]|7[47])\\d{6}|[2-7]\\d{6}', example_number='06031234', possible_length=(7, 8)),
    national_prefix_for_parsing='0(11\\d{6}|6[256]\\d{6}|7[47]\\d{6})',
