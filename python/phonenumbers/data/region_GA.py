...
PHONE_METADATA_GA = PhoneMetadata(id='GA', country_code=241, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='0?\\d{7}', possible_number_pattern='\\d{7,8}', possible_length=[8,7]),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='0?[2-7]\\d{6}', possible_number_pattern='\\d{7,8}', example_number='06031234', possible_length=[7,8]),
