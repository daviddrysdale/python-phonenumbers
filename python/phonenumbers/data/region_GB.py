...
PHONE_METADATA_GB = PhoneMetadata(id='GB', country_code=44, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='\\d{7,10}', possible_number_pattern='\\d{4,10}', possible_length=[9,10,7]),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='7(?:[1-4]\\d\\d|5(?:0[0-8]|[13-9]\\d|2[0-35-9])|7(?:0[1-9]|[1-7]\\d|8[02-9]|9[0-689])|8(?:[014-9]\\d|[23][0-8])|9(?:[04-9]\\d|1[02-9]|2[0-35-9]|3[0-689]))\\d{6}', possible_number_pattern='\\d{10}', example_number='7400123456', possible_length=[9,10,7]),
