...
PHONE_METADATA_GB = PhoneMetadata(id='GB', country_code=44, international_prefix='00',
    ...
    pager=PhoneNumberDesc(national_number_pattern='76(?:0[012]\\d|2(?:[356]\\d|4[013-9])|4[0134]\\d|5[49]\\d|6[0-369]\\d|77\\d|81\\d|9[39]\\d)\\d{5}', example_number='7640123456', possible_length=(10,)),
    ...
    number_format=[NumberFormat(pattern='(7\\d{3})(\\d{6})', format='\\1 \\2', leading_digits_pattern=['7(?:[1-5789]|62)', '7(?:[1-5789]|624)', '7(?:[1-5789]|6242)'], national_prefix_formatting_rule='0\\1'),
