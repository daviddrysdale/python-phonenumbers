...
PHONE_METADATA_GD = PhoneMetadata(id='GD', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='473(?:2(?:3[0-2]|69)|3(?:2[89]|86)|4(?:[06]8|3[5-9]|4[0-49]|5[5-79]|68|73|90)|63[68]|7(?:58|84)|938)\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='4732691234'),
    mobile=PhoneNumberDesc(national_number_pattern='473(?:4(?:0[3-79]|1[04-9]|20|58)|5(?:2[01]|3[3-8]))\\d{4}', possible_number_pattern='\\d{10}', example_number='4734031234'),
