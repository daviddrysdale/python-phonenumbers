...
PHONE_METADATA_GE = PhoneMetadata(id='GE', country_code=995, international_prefix='8~10',
    general_desc=PhoneNumberDesc(national_number_pattern=u'[13-79]\d{7}|8\d{8}', possible_number_pattern=u'\d{5,9}'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'(?:3(?:[256]\d|4[124-9]|7[0-4])|4(?:1\d|2[2-7]|3[1-79]|4[2-8]|7[239]|9[1-7]))\d{5}', possible_number_pattern=u'\d{5,8}', example_number=u'32123456'),
    mobile=PhoneNumberDesc(national_number_pattern=u'(?:14|5[01578]|6[28]|7[0147-9]|9[0-35-9])\d{6}', possible_number_pattern=u'\d{8}', example_number=u'55123456'),
