...
PHONE_METADATA_GE = PhoneMetadata(id='GE', country_code=995, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='5(?:0555[5-9]|757(?:7[7-9]|8[01]))\\d{3}|5(?:0070|[25]222|3333)[0-4]\\d{3}|5(?:00(?:0\\d|50)|111\\d|(?:52|75)00|8(?:58[89]|8(?:55|88)))\\d{4}|(?:5(?:[14]4|5[0157-9]|68|7[0147-9]|9[1-35-9])|790)\\d{6}', example_number='555123456', possible_length=(9,)),
