...
PHONE_METADATA_GF = PhoneMetadata(id='GF', country_code=594, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='594(?:10|2[012457-9]|3[0-57-9]|4[3-9]|5[7-9]|6[0-3]|9[014])\\d{4}', possible_number_pattern='\\d{9}', example_number='594101234', possible_length=(9,)),
    mobile=PhoneNumberDesc(national_number_pattern='694(?:[04][0-7]|1[0-5]|3[018]|[29]\\d)\\d{4}', possible_number_pattern='\\d{9}', example_number='694201234', possible_length=(9,)),
