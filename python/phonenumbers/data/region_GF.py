...
PHONE_METADATA_GF = PhoneMetadata(id='GF', country_code=594, international_prefix='00',
    ...
    voip=PhoneNumberDesc(national_number_pattern='9(?:396|76\\d)\\d{5}', example_number='976012345', possible_length=(9,)),
    national_prefix='0',
    national_prefix_for_parsing='0',
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{2})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['[56]|97'], national_prefix_formatting_rule='0\\1'),
