...
PHONE_METADATA_GI = PhoneMetadata(id='GI', country_code=350, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2(?:00\\d|1(?:6[24-7]|9\\d)|2(?:00|2[2457]))\\d{4}', possible_number_pattern='\\d{8}', example_number='20012345', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:5[46-8]|62)\\d{6}', possible_number_pattern='\\d{8}', example_number='57123456', possible_length=(8,)),
