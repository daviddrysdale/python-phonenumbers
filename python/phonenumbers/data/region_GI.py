...
PHONE_METADATA_GI = PhoneMetadata(id='GI', country_code=350, international_prefix='00',
    ...
    premium_rate=PhoneNumberDesc(national_number_pattern='8[1-689]\\d{6}', example_number='88123456', possible_length=(8,)),
    shared_cost=PhoneNumberDesc(national_number_pattern='87\\d{6}', example_number='87123456', possible_length=(8,)),
