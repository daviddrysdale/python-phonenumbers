...
PHONE_METADATA_GN = PhoneMetadata(id='GN', country_code=224, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='55\\d{6}|6(?:0(?:2\\d|3[3467]|5[2457-9])|[24578]\\d{2}|3(?:[14]0|35))\\d{4}', possible_number_pattern='\\d{8}', example_number='60201234'),
