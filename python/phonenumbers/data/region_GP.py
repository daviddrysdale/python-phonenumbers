...
PHONE_METADATA_GP = PhoneMetadata(id='GP', country_code=590, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='590(?:0[13468]|1[012]|2[0-68]|3[28]|4[0-8]|5[579]|6[0189]|70|8[0-689]|9\\d)\\d{4}', possible_number_pattern='\\d{9}', example_number='590201234', possible_length=(9,)),
    mobile=PhoneNumberDesc(national_number_pattern='690(?:0[0-7]|[1-9]\\d)\\d{4}', possible_number_pattern='\\d{9}', example_number='690301234', possible_length=(9,)),
