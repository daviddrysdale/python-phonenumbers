...
PHONE_METADATA_GP = PhoneMetadata(id='GP', country_code=590, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='590(?:0[1-68]|[14][0-24-9]|2[0-68]|3[1289]|5[3-579]|6[0-489]|7[08]|8[0-689]|9\\d)\\d{4}', example_number='590201234', possible_length=(9,)),
    ...
    voip=PhoneNumberDesc(national_number_pattern='9(?:395|76[018])\\d{5}', example_number='976012345', possible_length=(9,)),
    national_prefix='0',
