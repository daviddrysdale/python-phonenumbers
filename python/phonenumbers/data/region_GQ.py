...
PHONE_METADATA_GQ = PhoneMetadata(id='GQ', country_code=240, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='3(?:3(?:3\\d[7-9]|[0-24-9]\\d[46])|5\\d{2}[7-9])\\d{4}', possible_number_pattern='\\d{9}', example_number='333091234', possible_length=(9,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:222|55[15])\\d{6}', possible_number_pattern='\\d{9}', example_number='222123456', possible_length=(9,)),
