...
PHONE_METADATA_GQ = PhoneMetadata(id='GQ', country_code=240, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:222|551)\\d{6}', possible_number_pattern='\\d{9}', example_number='222123456'),
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{3})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[235]']),
