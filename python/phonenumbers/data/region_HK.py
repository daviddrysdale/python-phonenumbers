...
PHONE_METADATA_HK = PhoneMetadata(id='HK', country_code=852, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:[23]\\d|5[78])\\d{6}', possible_number_pattern='\\d{8}', example_number='21234567'),
    mobile=PhoneNumberDesc(national_number_pattern='(?:5[1-69]\\d|6\\d{2}|9(?:0[1-9]|[1-8]\\d))\\d{5}', possible_number_pattern='\\d{8}', example_number='51234567'),
