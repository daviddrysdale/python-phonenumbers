...
PHONE_METADATA_HR = PhoneMetadata(id='HR', country_code=385, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='(1)(\\d{4})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['1'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(6[029])(\\d{4})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['6[029]'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='([2-5]\\d)(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['[2-5]'], national_prefix_formatting_rule='0\\1'),
        ...
        NumberFormat(pattern='(\\d{2})(\\d{2})(\\d{2,3})', format='\\1 \\2 \\3', leading_digits_pattern=['6[145]|7'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(\\d{2})(\\d{3,4})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['6[145]|7'], national_prefix_formatting_rule='0\\1'),
