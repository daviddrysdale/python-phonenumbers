...
PHONE_METADATA_HR = PhoneMetadata(id='HR', country_code=385, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[1-7]\\d{5,8}|[89]\\d{6,11}', possible_number_pattern='\\d{6,12}', possible_length=(6, 7, 8, 9, 10, 11, 12), possible_length_local_only=(6, 7)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='9(?:[1-9]\\d{6,10}|01\\d{6,9})', possible_number_pattern='\\d{8,12}', example_number='912345678', possible_length=(8, 9, 10, 11, 12)),
    toll_free=PhoneNumberDesc(national_number_pattern='80[01]\\d{4,7}', possible_number_pattern='\\d{7,10}', example_number='8001234567', possible_length=(7, 8, 9, 10)),
    premium_rate=PhoneNumberDesc(national_number_pattern='6(?:[01459]\\d{4,7})', possible_number_pattern='\\d{6,9}', example_number='611234', possible_length=(6, 7, 8, 9)),
    shared_cost=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA'),
    personal_number=PhoneNumberDesc(national_number_pattern='7[45]\\d{4,7}', possible_number_pattern='\\d{6,9}', example_number='741234567', possible_length=(6, 7, 8, 9)),
    voip=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA'),
    pager=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA'),
    uan=PhoneNumberDesc(national_number_pattern='[76]2\\d{6,7}', possible_number_pattern='\\d{8,9}', example_number='62123456', possible_length=(8, 9)),
