...
PHONE_METADATA_HR = PhoneMetadata(id='HR', country_code=385, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1|6[029])\\d{7}|(?:2[0-3]|3[1-5]|4[02-47-9]|5[1-3])\\d{6}', possible_number_pattern='\\d{6,9}', example_number='12345678'),
    ...
    premium_rate=PhoneNumberDesc(national_number_pattern='6[145]\\d{4,7}', possible_number_pattern='\\d{6,9}', example_number='611234'),
