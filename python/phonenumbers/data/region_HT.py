...
PHONE_METADATA_HT = PhoneMetadata(id='HT', country_code=509, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2(?:[248]\\d|5[1-5]|94)\\d{5}', possible_number_pattern='\\d{8}', example_number='22453300', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:3[1-9]\\d|4\\d{2}|9(?:8[0-35]|9[5-9]))\\d{5}', possible_number_pattern='\\d{8}', example_number='34101234', possible_length=(8,)),
