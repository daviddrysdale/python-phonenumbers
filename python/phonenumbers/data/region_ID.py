...
PHONE_METADATA_ID = PhoneMetadata(id='ID', country_code=62, international_prefix='0(?:0[1789]|10(?:00|1[67]))',
    general_desc=PhoneNumberDesc(national_number_pattern=u'[1-9]\d{6,10}', possible_number_pattern=u'\d{5,11}'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'2[124]\d{7,8}|(?:2(?:[35][1-4]|6[0-8]|7[1-6]|8\d|9[1-8])|3(?:1|2[1-578]|3[1-68]|4[1-3]|5[1-8]|6[1-3568]|7[0-46]|8\d)|4(?:0[1-589]|1[01347-9]|2[0-36-8]|3[0-24-68]|5[1-378]|6[1-5]|7[134]|8[1245])|5(?:1[1-35-9]|2[25-8]|3[1246-9]|4[1-3589]|5[1-46]|6[1-8])|6(?:19?|[25]\d|3[1-469]|4[1-6])|7(?:1[1-46-9]|2[14-9]|[36]\d|4[1-8]|5[1-9]|7[0-36-9])|9(?:0[12]|1[0134-8]|2[0-479]|5[125-8]|6[23679]|7[159]|8[01346]))\d{5,8}', possible_number_pattern=u'\d{5,10}', example_number=u'612345678'),
    mobile=PhoneNumberDesc(national_number_pattern=u'8[1-35-9]\d{7,9}', possible_number_pattern=u'\d{9,11}', example_number=u'812345678'),
    toll_free=PhoneNumberDesc(national_number_pattern=u'177\d{6,8}|800\d{5,7}', possible_number_pattern=u'\d{8,11}', example_number=u'8001234567'),
    premium_rate=PhoneNumberDesc(national_number_pattern=u'809\d{7}', possible_number_pattern=u'\d{10}', example_number=u'8091234567'),
