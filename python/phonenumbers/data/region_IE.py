...
PHONE_METADATA_IE = PhoneMetadata(id='IE', country_code=353, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[124-9]\\d{6,9}', possible_number_pattern='\\d{5,10}', possible_length=[8,9,10,7], possible_length_local_only=[5,6]),
