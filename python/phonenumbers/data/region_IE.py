...
PHONE_METADATA_IE = PhoneMetadata(id='IE', country_code=353, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern=u'[124-9]\d{6,9}', possible_number_pattern=u'\d{5,10}'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'1\d{7,8}|2(?:1\d{6,7}|[24-9]\d{5}|3\d{5,7})|4(?:0[24]\d{5}|[1269]\d{7}|[34]\d{5,7}|5\d{6}|7\d{5}|8[0-46-9]\d{7})|5(?:0[45]\d{5}|1\d{6}|2\d{5,7}|[3679]\d{7}|8\d{5})|6(?:1\d{6}|4\d{5,7}|[237-9]\d{5}|[56]\d{7})|7[14]\d{7}|9(?:1\d{6}|[04]\d{7}|[3-9]\d{5})', possible_number_pattern=u'\d{5,10}', example_number=u'2212345'),
    mobile=PhoneNumberDesc(national_number_pattern=u'8(?:22\d{6}|[35-9]\d{7,8})', possible_number_pattern=u'\d{9,10}', example_number=u'850123456'),
    toll_free=PhoneNumberDesc(national_number_pattern=u'1800\d{6}', possible_number_pattern=u'\d{10}', example_number=u'1800123456'),
    premium_rate=PhoneNumberDesc(national_number_pattern=u'15(?:1[2-9]|[2-8]0|59|9[089])\d{6}', possible_number_pattern=u'\d{10}', example_number=u'1520123456'),
    shared_cost=PhoneNumberDesc(national_number_pattern=u'18[59]0\d{6}', possible_number_pattern=u'\d{10}', example_number=u'1850123456'),
    personal_number=PhoneNumberDesc(national_number_pattern=u'700\d{6}', possible_number_pattern=u'\d{9}', example_number=u'700123456'),
    voip=PhoneNumberDesc(national_number_pattern=u'76\d{7}', possible_number_pattern=u'\d{9}', example_number=u'761234567'),
    pager=PhoneNumberDesc(national_number_pattern=u'NA', possible_number_pattern=u'NA'),
    uan=PhoneNumberDesc(national_number_pattern=u'818\d{6}', possible_number_pattern=u'\d{9}', example_number=u'818123456'),
