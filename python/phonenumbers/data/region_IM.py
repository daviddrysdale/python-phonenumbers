...
PHONE_METADATA_IM = PhoneMetadata(id='IM', country_code=44, international_prefix='00',
    ...
    premium_rate=PhoneNumberDesc(national_number_pattern='(?:8(?:4(?:40[49]06|5624\\d)|7(?:0624|2299)\\d)|90[0167]624\\d)\\d{3}', example_number='9016247890', possible_length=(10,)),
    ...
    uan=PhoneNumberDesc(national_number_pattern='(?:3(?:(?:08162|3\\d{4}|7(?:0624|2299))\\d|4(?:40[49]06|5624\\d))|55\\d{5})\\d{3}', example_number='5512345678', possible_length=(10,)),
    national_prefix='0',
