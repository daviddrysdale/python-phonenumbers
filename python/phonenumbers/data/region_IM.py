...
PHONE_METADATA_IM = PhoneMetadata(id='IM', country_code=44, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='1624\\d{6}', possible_number_pattern='\\d{6,10}', example_number='1624456789', possible_length=(10,), possible_length_local_only=(6,)),
    mobile=PhoneNumberDesc(national_number_pattern='7[569]24\\d{6}', possible_number_pattern='\\d{10}', example_number='7924123456', possible_length=(10,)),
