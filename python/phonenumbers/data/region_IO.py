...
PHONE_METADATA_IO = PhoneMetadata(id='IO', country_code=246, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='37\\d{5}', possible_number_pattern='\\d{7}', example_number='3709100', possible_length=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='38\\d{5}', possible_number_pattern='\\d{7}', example_number='3801234', possible_length=(7,)),
