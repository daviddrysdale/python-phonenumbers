...
PHONE_METADATA_IR = PhoneMetadata(id='IR', country_code=98, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='9(?:(?:0(?:[1-35]\\d|44)|(?:[13]\\d|2[0-2])\\d)\\d|9(?:(?:[0-2]\\d|44)\\d|5[15]0|8(?:1[0-2]|88)|9(?:0[013]|1[0134]|21|77|9[6-9])))\\d{5}', example_number='9123456789', possible_length=(10,)),
