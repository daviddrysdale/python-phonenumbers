...
PHONE_METADATA_IR = PhoneMetadata(id='IR', country_code=98, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='(2[15])(\\d{3,5})', format=u'\\1 \\2', leading_digits_pattern=['2(?:1|5[0-47-9])'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(2[15])(\\d{3})(\\d{3,4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['2(?:1|5[0-47-9])'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(2\\d)(\\d{4})(\\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['2(?:[16]|5[0-47-9])'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{3,4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[13-9]|2[02-57-9]'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(\\d{3})(\\d{2})(\\d{2,3})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[13-9]|2[02-57-9]'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(\\d{3})(\\d{3})', format=u'\\1 \\2', leading_digits_pattern=['[13-9]|2[02-57-9]'], national_prefix_formatting_rule=u'0\\1')])
