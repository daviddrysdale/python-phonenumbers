...
PHONE_METADATA_IR = PhoneMetadata(id='IR', country_code=98, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='99(?:5[15]0|888|9(?:0[013]|21|77|88))\\d{5}|9(?:0(?:[1-35]\\d|4[4-6])|(?:[13]\\d|2[0-2])\\d|9(?:[0-2]\\d|3[01]|4[45]|81|9[19]))\\d{6}', example_number='9123456789', possible_length=(10,)),
