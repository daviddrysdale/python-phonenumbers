...
PHONE_METADATA_IR = PhoneMetadata(id='IR', country_code=98, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1[137]|2[13-68]|3[1458]|4[145]|5[146-8]|6[146]|7[1467]|8[13467])\\d{8}', possible_number_pattern='\\d{10}', example_number='2123456789', possible_length=(10,)),
    mobile=PhoneNumberDesc(national_number_pattern='9(?:0[1-3]|[13]\\d|2[0-2]|90)\\d{7}', possible_number_pattern='\\d{10}', example_number='9123456789', possible_length=(10,)),
