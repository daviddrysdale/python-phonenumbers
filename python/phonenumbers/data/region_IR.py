...
PHONE_METADATA_IR = PhoneMetadata(id='IR', country_code=98, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='9(?:(?:0(?:[0-35]\\d|4[4-6])|(?:[13]\\d|2[0-3])\\d)\\d|9(?:(?:[0-2]\\d|3[01]|4[0145])\\d|5[15]0|8(?:1\\d|88)|9(?:0[013]|[19]\\d|21|77|8[7-9])))\\d{5}', example_number='9123456789', possible_length=(10,)),
    voip=PhoneNumberDesc(national_number_pattern='993[2-9]\\d{6}', example_number='9932123456', possible_length=(10,)),
