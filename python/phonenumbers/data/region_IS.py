...
PHONE_METADATA_IS = PhoneMetadata(id='IS', country_code=354, international_prefix='1(?:0(?:01|10|20)|100)|00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='38[589]\\d{6}|(?:6(?:1[1-8]|2[056]|3[089]|4[0167]|5[0159]|[67][0-69]|9\\d)|7(?:5[057]|6[0-2]|[78]\\d)|8(?:2[0-59]|3[0-4]|[469]\\d|5[1-9]))\\d{4}', example_number='6111234', possible_length=(7, 9)),
