...
PHONE_METADATA_JM = PhoneMetadata(id='JM', country_code=1, international_prefix='011',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:658295|876(?:(?:2[14-9]|[348]\\d)\\d|5(?:0[13-9]|1[579]|[2-57-9]\\d|6[0-24-9])|6(?:4[89]|6[67])|7(?:0[07]|7\\d|8[1-47-9]|9[0-36-9])|9(?:[01]9|9[0579])))\\d{4}', example_number='8762101234', possible_length=(10,), possible_length_local_only=(7,)),
