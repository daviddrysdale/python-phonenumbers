...
PHONE_METADATA_JM = PhoneMetadata(id='JM', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='876(?:5(?:0[12]|1[0-468]|2[35]|63)|6(?:0[1-3579]|1[027]|2[3-5]|34|[45]0|63|7[05]|8[04]|9[4-9])7(?:0[2-689]|[1-6]\\d|8[056]|9[45])|9(?:0[1-8]|1[02378]|[2-8]\\d|9[2-468]))\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='8765123456'),
    mobile=PhoneNumberDesc(national_number_pattern='876(?:2(?:[178]\\d|99)|[348]\\d{2}|5(?:08|27|66|[78]\\d)|7(?:0[07]|7\\d|8[1-47-9]|9[0-36-9])|9(?:[01]9|9[0579]))\\d{4}', possible_number_pattern='\\d{10}', example_number='8762101234'),
