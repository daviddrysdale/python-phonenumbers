...
PHONE_METADATA_JM = PhoneMetadata(id='JM', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern=u'876(?:(?:5[0-26]|6\d|7[1-6]|9[2-8])\d{5}|(?:7(?:0[2-689]|8[056]|9[45])|9(?:0[1-8]|1[02378]|9[2-468]))\d{4})', possible_number_pattern=u'\d{7}(?:\d{3})?', example_number=u'8765123456'),
    mobile=PhoneNumberDesc(national_number_pattern=u'876(?:(?:21|[348]\d|5[78]|77)\d|7(?:0[07]|8[1-47-9]|9[0-36-9])|9(?:[01]9|9[0579]))\d{4}', possible_number_pattern=u'\d{10}', example_number=u'8762101234'),
