...
PHONE_METADATA_JO = PhoneMetadata(id='JO', country_code=962, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='7(?:55|7[025-9]|8[015-9]|9[0-25-9])\\d{6}', possible_number_pattern='\\d{9}', example_number='790123456', possible_length=(9,)),
