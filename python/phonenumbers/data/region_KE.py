...
PHONE_METADATA_KE = PhoneMetadata(id='KE', country_code=254, international_prefix='000',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:4[245]|5[2-79]|6[01457-9])\\d{5,7}|(?:4[136]|5[08]|62)\\d{7}|(?:[24]0|51|66)\\d{6,7}', example_number='202012345', possible_length=(7, 8, 9)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:1(?:0[0-2]|1[01])|7\\d\\d)\\d{6}', example_number='712123456', possible_length=(9,)),
