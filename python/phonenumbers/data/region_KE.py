...
PHONE_METADATA_KE = PhoneMetadata(id='KE', country_code=254, international_prefix='000',
    general_desc=PhoneNumberDesc(national_number_pattern='20\\d{6,7}|[4-9]\\d{6,9}', possible_number_pattern='\\d{7,10}', possible_length=[8,9,10,7]),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='7(?:[0-36]\\d|5[0-6]|[79][0-7]|8[0-25-9])\\d{6}', possible_number_pattern='\\d{9}', example_number='712123456', possible_length=[9]),
