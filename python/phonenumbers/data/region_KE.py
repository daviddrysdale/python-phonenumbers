...
PHONE_METADATA_KE = PhoneMetadata(id='KE', country_code=254, international_prefix='000',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='20\\d{6,7}|4(?:0\\d{6,7}|[136]\\d{7}|[245]\\d{5,7})|5(?:[08]\\d{7}|[1-79]\\d{5,7})|6(?:[01457-9]\\d{5,7}|2\\d{7}|6\\d{6,7})', possible_number_pattern='\\d{7,9}', example_number='202012345', possible_length=(7, 8, 9)),
