...
PHONE_METADATA_KG = PhoneMetadata(id='KG', country_code=996, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[35-8]\\d{8,9}', possible_number_pattern='\\d{5,10}'),
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['31[25]|[5-7]'], national_prefix_formatting_rule='0\\1'),
