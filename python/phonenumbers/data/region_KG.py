...
PHONE_METADATA_KG = PhoneMetadata(id='KG', country_code=996, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:312(?:58\\d|973)|8801\\d\\d)\\d{3}|(?:2(?:0[0-35]|2\\d)|5[0-24-7]\\d|7(?:[07]\\d|55)|99[05-9])\\d{6}', example_number='700123456', possible_length=(9,)),
