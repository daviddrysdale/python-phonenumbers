...
PHONE_METADATA_KH = PhoneMetadata(id='KH', country_code=855, international_prefix='00[14-9]',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:2[3-6]|3[2-6]|4[2-4]|[567][2-5])(?:[2-47-9]|5\\d|6\\d?)\\d{5}|(?:23[48]|[456]3\\d|)\\d{6}', possible_number_pattern='\\d{6,9}', example_number='23456789'),
    mobile=PhoneNumberDesc(national_number_pattern='(?:(?:1\\d|6[016-9]|7[07-9]|)[1-9]|(?:12|31|76)[1-9]\\d|8(?:0[89]|[134679]\\d|5[2-9]|8\\d{2})|9(?:[0-589][1-9]|[67][1-9]\\d?))\\d{5}', possible_number_pattern='\\d{8,9}', example_number='91234567'),
