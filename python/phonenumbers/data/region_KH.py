...
PHONE_METADATA_KH = PhoneMetadata(id='KH', country_code=855, international_prefix='00[14-9]',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:(?:1\\d|6[016-9]|7(?:[07-9]|6\\d))[1-9]|8(?:0[89]|[134679]\\d|5[2-9]|8\\d{2})|9(?:[0-589][1-9]|[67][1-9]\\d?))\\d{5}', possible_number_pattern='\\d{8,9}', example_number='91234567'),
