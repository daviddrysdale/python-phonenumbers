...
PHONE_METADATA_KM = PhoneMetadata(id='KM', country_code=269, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='7(?:6[0-37-9]|7[0-57-9])\\d{4}', possible_number_pattern='\\d{7}', example_number='7712345', possible_length=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='3[234]\\d{5}', possible_number_pattern='\\d{7}', example_number='3212345', possible_length=(7,)),
