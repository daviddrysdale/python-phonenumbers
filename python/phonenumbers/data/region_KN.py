...
PHONE_METADATA_KN = PhoneMetadata(id='KN', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='869(?:2(?:29|36)|4(?:6[5-9]|70))\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='8692361234'),
    mobile=PhoneNumberDesc(national_number_pattern='869(?:5(?:5[6-8]|6[5-7])|66[2-9]|76[2-5])\\d{4}', possible_number_pattern='\\d{10}', example_number='8695561234'),
