...
PHONE_METADATA_KN = PhoneMetadata(id='KN', country_code=1, international_prefix='011',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='869(?:48[89]|5(?:5[6-8]|6[5-7])|66\\d|76[02-7])\\d{4}', example_number='8697652917', possible_length=(10,), possible_length_local_only=(7,)),
