...
PHONE_METADATA_KP = PhoneMetadata(id='KP', country_code=850, international_prefix='00|99',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:(?:19\\d|2)\\d|85)\\d{6}', possible_length=(8, 10), possible_length_local_only=(6, 7)),
    ...
    no_international_dialling=PhoneNumberDesc(national_number_pattern='2(?:[0-24-9]\\d\\d|3(?:[0-79]\\d|8[02-9]))\\d{4}', possible_length=(8,)),
    national_prefix='0',
