...
PHONE_METADATA_KR = PhoneMetadata(id='KR', country_code=82, international_prefix='00(?:[124-68]|3\\d{2}|7(?:[0-8]\\d|9[0-79]))',
    ...
    uan=PhoneNumberDesc(national_number_pattern='1(?:5(?:44|66|77|88|99)|6(?:00|44|6[16]|70|88)|8(?:00|33|55|77|99))\\d{4}', possible_number_pattern='\\d{8}', example_number='15441234', possible_length=(8,)),
