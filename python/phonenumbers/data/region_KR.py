...
PHONE_METADATA_KR = PhoneMetadata(id='KR', country_code=82, international_prefix='00(?:[124-68]|[37]\\d{2})',
    ...
    number_format=[NumberFormat(pattern='(\\d{3})', format=u'\\1', leading_digits_pattern=['11[29]'], national_prefix_formatting_rule=u'\\1', domestic_carrier_code_formatting_rule=u'0$CC-\\1'),
        NumberFormat(pattern='(\\d{2})(\\d{4})(\\d{4})', format=u'\\1-\\2-\\3', leading_digits_pattern=['1(?:0|1[19]|[69]9|5[458])|[57]0', '1(?:0|1[19]|[69]9|5(?:44|59|8))|[57]0'], national_prefix_formatting_rule=u'0\\1', domestic_carrier_code_formatting_rule=u'0$CC-\\1'),
