...
PHONE_METADATA_KR = PhoneMetadata(id='KR', country_code=82, international_prefix='00(?:[124-68]|[37]\\d{2})',
    ...
    number_format=[NumberFormat(pattern='(\\d{3})', format='\\1', leading_digits_pattern=['11[29]'], national_prefix_formatting_rule='\\1', domestic_carrier_code_formatting_rule='0$CC-\\1'),
