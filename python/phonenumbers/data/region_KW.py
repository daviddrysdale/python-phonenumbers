...
PHONE_METADATA_KW = PhoneMetadata(id='KW', country_code=965, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:5(?:2(?:22|5[25])|88[58])|6(?:222|333|444|70[013-9]|888|93[039])|9(?:11[01]|3(?:00|33)|500))\\d{4}|(?:5(?:[05]\\d|1[0-7]|6[56])|6(?:0[034679]|5[015-9]|6\\d|7[67]|9[069])|9(?:0[09]|22|[4679]\\d|55|8[057-9]))\\d{5}', example_number='50012345', possible_length=(8,)),
