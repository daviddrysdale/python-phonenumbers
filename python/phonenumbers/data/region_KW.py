...
PHONE_METADATA_KW = PhoneMetadata(id='KW', country_code=965, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:5(?:0[0-2568]|5\\d)|6(?:0[034679]|5(?:[015-79]|8(?:[02-9]|1[0-57-9]))|6\\d|7[067]|9[69])|9(?:0[09]|4[049]|6[69]|[79]\\d))\\d{5}', possible_number_pattern='\\d{8}', example_number='50012345'),
