...
PHONE_METADATA_KY = PhoneMetadata(id='KY', country_code=1, international_prefix='011',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='345(?:32[1-9]|5(?:1[67]|2[5-7]|4[6-8]|76)|9(?:1[67]|2[3-9]|3[689]))\\d{4}', possible_number_pattern='\\d{10}', example_number='3453231234'),
