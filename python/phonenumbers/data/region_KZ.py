...
PHONE_METADATA_KZ = PhoneMetadata(id='KZ', country_code=7, international_prefix='810',
    general_desc=PhoneNumberDesc(national_number_pattern='33622\\d{5}|(?:7\\d|80)\\d{8}', possible_length=(10,), possible_length_local_only=(5, 6, 7)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='7(?:0[0-25-8]|47|6[02-4]|7[15-8]|85)\\d{7}', example_number='7710009998', possible_length=(10,)),
