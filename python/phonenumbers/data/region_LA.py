...
PHONE_METADATA_LA = PhoneMetadata(id='LA', country_code=856, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:2[13]|[35-7][14]|41|8[1468])\\d{6}', possible_number_pattern='\\d{6,8}', example_number='21212862'),
    mobile=PhoneNumberDesc(national_number_pattern='20(?:2[2389]|5[4-689]|7[6-8]|9[57-9])\\d{6}', possible_number_pattern='\\d{10}', example_number='2023123456'),
    ...
    number_format=[NumberFormat(pattern='(20)(\\d{2})(\\d{3})(\\d{3})', format=u'\\1 \\2 \\3 \\4', leading_digits_pattern=['20'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='([2-8]\\d)(\\d{3})(\\d{3})', format=u'\\1 \\2 \\3', leading_digits_pattern=['2[13]|[3-8]'], national_prefix_formatting_rule=u'0\\1')])
