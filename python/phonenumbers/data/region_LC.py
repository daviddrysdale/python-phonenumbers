...
PHONE_METADATA_LC = PhoneMetadata(id='LC', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='758(?:234|4(?:5[0-9]|6[2-9]|8[0-2])|638|758)\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='7582345678'),
    mobile=PhoneNumberDesc(national_number_pattern='758(?:28[4-7]|384|4(?:6[01]|8[4-9])|5(?:1[89]|20|84)|7(?:1[2-9]|2[0-4]))\\d{4}', possible_number_pattern='\\d{10}', example_number='7582845678'),
