...
PHONE_METADATA_LI = PhoneMetadata(id='LI', country_code=423, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:(?:[2378]|6\\d\\d)\\d|90)\\d{5}', possible_length=(7, 9)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:6(?:5(?:09|1\\d|20)|6(?:0[0-6]|10|2[06-9]|39))\\d|7(?:[37-9]\\d|42|56))\\d{4}', example_number='660234567', possible_length=(7, 9)),
