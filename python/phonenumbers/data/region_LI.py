...
PHONE_METADATA_LI = PhoneMetadata(id='LI', country_code=423, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='6(?:51[01]|6(?:[01][0-4]|2[016-9]|88|92)|710)\\d{5}|7(?:36|4[25]|56|[6-9]\\d)\\d{4}', possible_number_pattern='\\d{7,9}', example_number='661234567'),
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{2})(\\d{2})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[23]|7[3-9]|87']),
