...
PHONE_METADATA_LI = PhoneMetadata(id='LI', country_code=423, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:6(?:4(?:89|9\\d)|5[0-3]\\d|6(?:0[0-7]|10|2[06-9]|39))\\d|7(?:[37-9]\\d|42|56))\\d{4}', example_number='660234567', possible_length=(7, 9)),
