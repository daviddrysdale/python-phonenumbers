...
PHONE_METADATA_LI = PhoneMetadata(id='LI', country_code=423, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:2(?:01|1[27]|3\\d|6[02-578]|96)|3(?:7[0135-7]|8[048]|9[0269])|870)\\d{4}', possible_number_pattern='\\d{7}', example_number='2345678'),
    mobile=PhoneNumberDesc(national_number_pattern='6(?:51[01]|6(?:[01][0-4]|2[016-9]|88|92)|710)\\d{5}|7(?:36|4[25]|56|[7-9]\\d)\\d{4}', possible_number_pattern='\\d{7,9}', example_number='661234567'),
    ...
    shared_cost=PhoneNumberDesc(national_number_pattern='90(?:0(?:2[278]|79)|1(?:23|3[012])|6(?:4\\d|6[0126]))\\d{2}', possible_number_pattern='\\d{7}', example_number='9002222'),
    ...
    uan=PhoneNumberDesc(national_number_pattern='87(?:0[1289]|70)\\d{3}', possible_number_pattern='\\d{7}', example_number='8770123'),
