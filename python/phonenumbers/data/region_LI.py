...
PHONE_METADATA_LI = PhoneMetadata(id='LI', country_code=423, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='6\\d{8}|[23789]\\d{6}', possible_number_pattern='\\d{7,9}', possible_length=(7, 9)),
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:2(?:01|1[27]|3\\d|6[02-578]|96)|3(?:7[0135-7]|8[048]|9[0269]))\\d{4}', possible_number_pattern='\\d{7}', example_number='2345678', possible_length=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='6(?:51[01]|6(?:0[0-6]|2[016-9]|39))\\d{5}|7(?:[37-9]\\d|42|56)\\d{4}', possible_number_pattern='\\d{7,9}', example_number='660234567', possible_length=(7, 9)),
    ...
    voicemail=PhoneNumberDesc(national_number_pattern='697(?:42|56|[7-9]\\d)\\d{4}', possible_number_pattern='\\d{9}', example_number='697861234', possible_length=(9,)),
