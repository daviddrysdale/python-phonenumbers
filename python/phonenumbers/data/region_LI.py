...
PHONE_METADATA_LI = PhoneMetadata(id='LI', country_code=423, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{2})(\\d{2})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[23]|7[3-57-9]|87']),
        NumberFormat(pattern='(6\\d)(\\d{3})(\\d{3})', format=u'\\1 \\2 \\3', leading_digits_pattern=['6']),
        NumberFormat(pattern='(6[567]\\d)(\\d{3})(\\d{3})', format=u'\\1 \\2 \\3', leading_digits_pattern=['6[567]']),
        NumberFormat(pattern='(69)(7\\d{2})(\\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['697']),
