...
PHONE_METADATA_LK = PhoneMetadata(id='LK', country_code=94, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1(?:1[2-57]\\d|973)|(?:2[13-7]|3[1-8]|4[157]|5[12457]|6[35-7]|[89]1)[2-57]\\d)\\d{5}', example_number='112345678', possible_length=(9,), possible_length_local_only=(7,)),
