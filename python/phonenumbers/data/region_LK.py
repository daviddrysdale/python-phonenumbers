...
PHONE_METADATA_LK = PhoneMetadata(id='LK', country_code=94, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:[189]1|2[13-7]|3[1-8]|4[157]|5[12457]|6[35-7])[2-57]\\d{6}', possible_number_pattern='\\d{7,9}', example_number='112345678', possible_length=(9,), possible_length_local_only=(7,)),
