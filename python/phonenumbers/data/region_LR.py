...
PHONE_METADATA_LR = PhoneMetadata(id='LR', country_code=231, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:4[67]|5\\d|6[4-8]|7(?:7[67]\\d|\\d{2})|88\\d{2})\\d{5}', possible_number_pattern='\\d{7,9}', example_number='4612345'),
    ...
    number_format=[NumberFormat(pattern='([279]\\d)(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['[279]'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(7\\d{2})(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['7'], national_prefix_formatting_rule='0\\1'),
