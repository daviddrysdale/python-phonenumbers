...
PHONE_METADATA_LS = PhoneMetadata(id='LS', country_code=266, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2\\d{7}', possible_number_pattern='\\d{8}', example_number='22123456', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='[56]\\d{7}', possible_number_pattern='\\d{8}', example_number='50123456', possible_length=(8,)),
