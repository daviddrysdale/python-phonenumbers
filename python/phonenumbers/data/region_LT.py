...
PHONE_METADATA_LT = PhoneMetadata(id='LT', country_code=370, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='([34]\\d)(\\d{2})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['37|4(?:1|5[45]|6[2-4])'], national_prefix_formatting_rule='8 \\1'),
        NumberFormat(pattern='([3-9]\\d{2})(\\d{2})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['3[148]|4(?:[24]|6[09])|5(?:[0189]|28)|[6-9]'], national_prefix_formatting_rule='8 \\1'),
        NumberFormat(pattern='(5)(2[0-79]\\d)(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['52[0-79]'], national_prefix_formatting_rule='8 \\1')])
