...
PHONE_METADATA_LU = PhoneMetadata(id='LU', country_code=352, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[24-9]\\d{3,10}|3(?:[0-46-9]\\d{2,9}|5[013-9]\\d{1,8})', possible_number_pattern='\\d{4,11}', possible_length=(4, 5, 6, 7, 8, 9, 10, 11)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='6[2679][18]\\d{6}', possible_number_pattern='\\d{9}', example_number='628123456', possible_length=(9,)),
    ...
    premium_rate=PhoneNumberDesc(national_number_pattern='90[015]\\d{5}', possible_number_pattern='\\d{8}', example_number='90012345', possible_length=(8,)),
