...
PHONE_METADATA_LV = PhoneMetadata(id='LV', country_code=371, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='6\\d{7}', possible_number_pattern='\\d{8}', example_number='63123456', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='2\\d{7}', possible_number_pattern='\\d{8}', example_number='21234567', possible_length=(8,)),
