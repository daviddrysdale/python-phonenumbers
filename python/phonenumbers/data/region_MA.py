...
PHONE_METADATA_MA = PhoneMetadata(id='MA', country_code=212, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='5(?:2(?:(?:[015-7]\\d|2[02-9]|3[2-57]|4[2-8]|8[235-7])\\d|9(?:0\\d|[89]0))|3(?:(?:[0-4]\\d|[57][2-9]|6[235-8]|9[3-9])\\d|8(?:0\\d|[89]0))|(?:4[067]|5[03])\\d{2})\\d{4}', possible_number_pattern='\\d{9}', example_number='520123456'),
    mobile=PhoneNumberDesc(national_number_pattern='(?:6(?:[0-79]\\d|8[0-247-9])|7(?:[07][07]|6[12]))\\d{6}', possible_number_pattern='\\d{9}', example_number='650123456'),
    ...
    voip=PhoneNumberDesc(national_number_pattern='5924[01]\\d{4}', possible_number_pattern='\\d{9}', example_number='592401234'),
    ...
    number_format=[NumberFormat(pattern='([5-7]\\d{2})(\\d{6})', format='\\1-\\2', leading_digits_pattern=['5(?:2[015-7]|3[0-4])|[67]'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='([58]\\d{3})(\\d{5})', format='\\1-\\2', leading_digits_pattern=['5(?:2[2-489]|3[5-9]|92)|892', '5(?:2(?:[2-48]|90)|3(?:[5-79]|80)|924)|892'], national_prefix_formatting_rule='0\\1'),
