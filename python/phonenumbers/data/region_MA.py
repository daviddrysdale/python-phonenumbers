...
PHONE_METADATA_MA = PhoneMetadata(id='MA', country_code=212, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='5(?:2(?:(?:[015-7]\\d|2[2-9]|3[2-57]|4[2-8]|8[235-9])\\d|9(?:0\\d|[89]0))|3(?:(?:[0-4]\\d|[57][2-9]|6[235-8]|9[3-9])\\d|8(?:0\\d|[89]0)))\\d{4}', possible_number_pattern='\\d{9}', example_number='520123456'),
    mobile=PhoneNumberDesc(national_number_pattern='6(?:0[0-6]|[14-7]\\d|2[236-9]|3[03458]|8[01]|99)\\d{6}', possible_number_pattern='\\d{9}', example_number='650123456'),
