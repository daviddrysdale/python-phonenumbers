...
PHONE_METADATA_MA = PhoneMetadata(id='MA', country_code=212, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{6})', format='\\1-\\2', leading_digits_pattern=['5(?:2[015-7]|3[0-4])|[67]'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(\\d{4})(\\d{5})', format='\\1-\\2', leading_digits_pattern=['5(?:2[2-489]|3[5-9]|9)|892', '5(?:2(?:[2-48]|9[0-7])|3(?:[5-79]|8[0-7])|9)|892'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(\\d{5})(\\d{4})', format='\\1-\\2', leading_digits_pattern=['5[23]'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(\\d{3})(\\d{2})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['5'], national_prefix_formatting_rule='0\\1'),
