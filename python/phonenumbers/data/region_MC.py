...
PHONE_METADATA_MC = PhoneMetadata(id='MC', country_code=377, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[4689]\\d{7,8}', possible_number_pattern='\\d{8,9}', possible_length=(8, 9)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='6\\d{8}|4(?:4\\d|5[1-9])\\d{5}', possible_number_pattern='\\d{8,9}', example_number='612345678', possible_length=(8, 9)),
    ...
    no_international_dialling=PhoneNumberDesc(national_number_pattern='8\\d{7}', possible_number_pattern='\\d{8}', possible_length=(8,)),
    national_prefix='0',
