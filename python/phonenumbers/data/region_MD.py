...
PHONE_METADATA_MD = PhoneMetadata(id='MD', country_code=373, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:562\\d|6(?:[0289]\\d{2}|1[01]\\d|21\\d|7(?:[1-6]\\d|7[0-4]))|7(?:6[07]|7[457-9]|[89]\\d)\\d)\\d{4}', possible_number_pattern='\\d{8}', example_number='62112345'),
