...
PHONE_METADATA_ME = PhoneMetadata(id='ME', country_code=382, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:20[2-8]|3(?:0[2-7]|1[35-7]|2[367]|3[4-7])|4(?:0[237]|1[2467])|5(?:0[47]|1[27]|2[378]))\\d{5}', possible_number_pattern='\\d{6,8}', example_number='30234567'),
