...
PHONE_METADATA_ME = PhoneMetadata(id='ME', country_code=382, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='6(?:00\\d|3[24]\\d|61\\d|7(?:[0-8]\\d|9(?:[3-9]|[0-2]\\d))|[89]\\d{2})\\d{4}', possible_number_pattern='\\d{8,9}', example_number='67622901'),
