...
PHONE_METADATA_ME = PhoneMetadata(id='ME', country_code=382, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['[2-57-9]|6[3789]', '[2-57-9]|6(?:[389]|7(?:[0-8]|9[3-9]))'], national_prefix_formatting_rule='0\\1'),
