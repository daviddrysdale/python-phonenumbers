...
PHONE_METADATA_MG = PhoneMetadata(id='MG', country_code=261, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='20(?:(?:2\\d|4[47]|5[3467]|6[279]|8[268]|9[245])\\d|7(?:2[29]|[35]\\d))\\d{4}', example_number='202123456', possible_length=(9,), possible_length_local_only=(7,)),
