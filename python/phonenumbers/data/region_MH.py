...
PHONE_METADATA_MH = PhoneMetadata(id='MH', country_code=692, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:247|528|625)\\d{4}', possible_number_pattern='\\d{7}', example_number='2471234', possible_length=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:235|329|45[56]|545)\\d{4}', possible_number_pattern='\\d{7}', example_number='2351234', possible_length=(7,)),
