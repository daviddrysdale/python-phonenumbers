...
PHONE_METADATA_MK = PhoneMetadata(id='MK', country_code=389, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='7(?:3555|(?:474|9[019]7)7)\\d{3}|7(?:[0-25-8]\\d\\d|3(?:[1-48]\\d|7[01578])|4(?:2\\d|60|7[01578])|9(?:[2-4]\\d|7[015]))\\d{4}', example_number='72345678', possible_length=(8,)),
