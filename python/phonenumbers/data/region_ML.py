...
PHONE_METADATA_ML = PhoneMetadata(id='ML', country_code=223, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:2(?:0(?:2\\d|7[0-8])|1(?:2[5-7]|[3-689]\\d))|44[1239]\\d)\\d{4}', possible_number_pattern='\\d{8}', example_number='20212345', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:2(?:079|17\\d)|[679]\\d{3}|8[239]\\d{2})\\d{4}', possible_number_pattern='\\d{8}', example_number='65012345', possible_length=(8,)),
