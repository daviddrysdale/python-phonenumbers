...
PHONE_METADATA_ML = PhoneMetadata(id='ML', country_code=223, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:2(?:0(?:2[0-589]|7[027-9])|1(?:2[5-7]|[3-689]\\d))|44[239]\\d)\\d{4}', possible_number_pattern='\\d{8}', example_number='20212345'),
    mobile=PhoneNumberDesc(national_number_pattern='(?:6[3569]|7\\d)\\d{6}', possible_number_pattern='\\d{8}', example_number='65012345'),
