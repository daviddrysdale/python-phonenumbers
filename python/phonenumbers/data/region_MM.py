...
PHONE_METADATA_MM = PhoneMetadata(id='MM', country_code=95, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:17[01]|9(?:2[0-4]|(?:3[0-36]|(?:6\\d|8[89]|98)\\d)\\d|4(?:[1379]\\d|88)|5[0-6])\\d)\\d{4}|9(?:[69]1|73)\\d{6}|9(?:[68]\\d|9[089])\\d{5}|9(?:2[56]|34|4[0245]|7[5-9]|9[4-7])\\d{7}', example_number='92123456', possible_length=(7, 8, 9, 10)),
