...
PHONE_METADATA_MM = PhoneMetadata(id='MM', country_code=95, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[14578]\\d{5,7}|[26]\\d{5,8}|9(?:2\\d{0,2}|[58]|3\\d|4\\d{1,2}|[679]\\d?)\\d{6}', possible_number_pattern='\\d{5,10}'),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='17[01]\\d{4}|9(?:2(?:[0-4]|5\\d{2})|3[136]\\d|4(?:0[0-4]\\d|[1379]\\d|[24][0-589]\\d|5\\d{2}|88)|5[0-6]|61?\\d|73\\d|8\\d|9(?:1\\d|[089]))\\d{5}', possible_number_pattern='\\d{7,10}', example_number='92123456'),
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{3})(\\d{3,4})', format='\\1 \\2 \\3', leading_digits_pattern=['1|2[45]'], national_prefix_formatting_rule='0\\1'),
        ...
        NumberFormat(pattern='(9)(\\d{3})(\\d{4,5})', format='\\1 \\2 \\3', leading_digits_pattern=['9(?:2[0-4]|[35-9]|4[13789])'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(9)(4\\d{4})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['94[0245]'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(9)(\\d{3})(\\d{3})(\\d{3})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['925'], national_prefix_formatting_rule='0\\1')])
