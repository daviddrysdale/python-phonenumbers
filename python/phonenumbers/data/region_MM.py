...
PHONE_METADATA_MM = PhoneMetadata(id='MM', country_code=95, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='(1)(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['1'], national_prefix_formatting_rule='0\\1'),
        ...
        NumberFormat(pattern='(9)(\\d{3})(\\d{4,5})', format='\\1 \\2 \\3', leading_digits_pattern=['9(?:[25-9]|4[1349])'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(9)(4\\d{4})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['94[0256]'], national_prefix_formatting_rule='0\\1')])
