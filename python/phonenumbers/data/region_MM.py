...
PHONE_METADATA_MM = PhoneMetadata(id='MM', country_code=95, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern=u'[124-8]\d{5,7}|9\d{7,8}', possible_number_pattern=u'\d{5,9}'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'(?:1\d|2|4[2-6]|5[2-9]|6\d|7[0-5]|8[1-6])\d{5}|1333\d{4}', possible_number_pattern=u'\d{5,8}', example_number=u'1234567'),
    mobile=PhoneNumberDesc(national_number_pattern=u'9(?:[25689]\d|444)\d{5}', possible_number_pattern=u'\d{8,9}', example_number=u'92123456'),
