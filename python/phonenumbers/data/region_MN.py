...
PHONE_METADATA_MN = PhoneMetadata(id='MN', country_code=976, international_prefix='001',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='[12](?:1\\d|2(?:[1-3]\\d?|7\\d)|3[2-8]\\d{1,2}|4[2-68]\\d{1,2}|5[1-4689]\\d{1,2})\\d{5}|(?:5[0568]|70)\\d{6}', possible_number_pattern='\\d{6,10}', example_number='70123456'),
    mobile=PhoneNumberDesc(national_number_pattern='(?:8[89]|9[15689])\\d{6}', possible_number_pattern='\\d{8}', example_number='88123456'),
