...
PHONE_METADATA_MN = PhoneMetadata(id='MN', country_code=976, international_prefix='001',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='[12]2[1-3]\\d{5,6}|70[0-5]\\d{5}|(?:[12](?:1|27)|5[03568])\\d{6}|[12](?:3[2-8]|4[2-68]|5[1-4689])\\d{6,7}', example_number='50123456', possible_length=(8, 9, 10), possible_length_local_only=(4, 5, 6)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:8(?:[05689]\\d|3[01])|9(?:[013-9]\\d|20))\\d{5}', example_number='88123456', possible_length=(8,)),
    voip=PhoneNumberDesc(national_number_pattern='7[15-8]\\d{6}', example_number='75123456', possible_length=(8,)),
    national_prefix='0',
