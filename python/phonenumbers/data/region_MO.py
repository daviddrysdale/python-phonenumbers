...
PHONE_METADATA_MO = PhoneMetadata(id='MO', country_code=853, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='6800[0-79]\\d{3}|6(?:[235]\\d\\d|6(?:0[0-5]|[1-9]\\d)|8(?:0[1-9]|[146-8]\\d|2[5-9]|[35][0-4]))\\d{4}', example_number='66123456', possible_length=(8,)),
