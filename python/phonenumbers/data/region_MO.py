...
PHONE_METADATA_MO = PhoneMetadata(id='MO', country_code=853, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='08005\\d\\d|(?:28|[68]\\d)\\d{6}', possible_length=(7, 8)),
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='08005\\d\\d', example_number='0800501', possible_length=(7,)),
