...
PHONE_METADATA_MP = PhoneMetadata(id='MP', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='670(?:2(?:3[3-5]|88|56)|32[23]|4[38]3|532|6(?:64|70|8\\d))\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='6702345678'),
    mobile=PhoneNumberDesc(national_number_pattern='670(?:2(?:3[3-5]|88|56)|32[23]|4[38]3|532|6(?:64|70|8\\d))\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='6702345678'),
