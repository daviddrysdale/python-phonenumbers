...
PHONE_METADATA_MR = PhoneMetadata(id='MR', country_code=222, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:2(?:2\\d|70)|3(?:3\\d|6[1-36]|7[1-3])|4(?:4\\d|6[0457-9]|7[4-9]|8[01346-8]))\\d{5}', possible_number_pattern='\\d{8}', example_number='22123456'),
