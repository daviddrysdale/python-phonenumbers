...
PHONE_METADATA_MS = PhoneMetadata(id='MS', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='664491\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='6644912345', possible_length=(10,), possible_length_local_only=(7,)),
