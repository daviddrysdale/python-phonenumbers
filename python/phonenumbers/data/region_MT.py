...
PHONE_METADATA_MT = PhoneMetadata(id='MT', country_code=356, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2(?:0(?:1[0-6]|3[1-4]|[69]\\d)|[1-357]\\d{2})\\d{4}', possible_number_pattern='\\d{8}', example_number='21001234', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:7(?:210|[79]\\d{2})|9(?:2(?:1[01]|31)|696|8(?:1[1-3]|89|97)|9\\d{2}))\\d{4}', possible_number_pattern='\\d{8}', example_number='96961234', possible_length=(8,)),
