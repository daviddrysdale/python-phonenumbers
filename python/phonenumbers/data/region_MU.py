...
PHONE_METADATA_MU = PhoneMetadata(id='MU', country_code=230, international_prefix='0(?:[2-7]0|33)',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:2(?:[034789]\\d|1[0-7]|6[1-69])|4(?:[013-8]\\d|2[4-7])|[56]\\d{2}|8(?:14|3[129]))\\d{4}', possible_number_pattern='\\d{7}', example_number='2012345'),
    mobile=PhoneNumberDesc(national_number_pattern='(?:25\\d|4(?:2[12389]|9\\d)|7\\d{2}|8(?:20|7[15-8])|9[1-8]\\d)\\d{4}', possible_number_pattern='\\d{7}', example_number='2512345'),
