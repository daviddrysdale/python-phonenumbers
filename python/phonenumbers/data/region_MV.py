...
PHONE_METADATA_MV = PhoneMetadata(id='MV', country_code=960, international_prefix='0(?:0|19)',
    general_desc=PhoneNumberDesc(national_number_pattern='[3467]\\d{6}|9(?:00\\d{7}|\\d{6})', possible_number_pattern='\\d{7,10}', possible_length=(7, 10)),
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:3(?:0[01]|3[0-59])|6(?:[567][02468]|8[024689]|90))\\d{4}', possible_number_pattern='\\d{7}', example_number='6701234', possible_length=(7,)),
