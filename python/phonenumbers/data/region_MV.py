...
PHONE_METADATA_MV = PhoneMetadata(id='MV', country_code=960, international_prefix='0(?:0|19)',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:46[46]|7[3-9]\\d|9[6-9]\\d)\\d{4}', possible_number_pattern='\\d{7}', example_number='7712345'),
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{4})', format=u'\\1-\\2', leading_digits_pattern=['[3467]|9(?:[1-9]|0[1-9])']),
