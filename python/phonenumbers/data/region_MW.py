...
PHONE_METADATA_MW = PhoneMetadata(id='MW', country_code=265, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:[3-5]|[27]\\d{2}|[189](?:\\d{2})?)\\d{6}', possible_number_pattern='\\d{7,9}'),
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1[2-9]|21\\d{2})\\d{5}', possible_number_pattern='\\d{7,9}', example_number='1234567'),
    mobile=PhoneNumberDesc(national_number_pattern='(?:111|[3-5]|77\\d|8(?:8\\d)?|9(?:9\\d)?)\\d{6}', possible_number_pattern='\\d{7,9}', example_number='991234567'),
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{3})(\\d{3})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[13-5]'], national_prefix_formatting_rule=u'0\\1'),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{2})(\\d{2})(\\d{2})', format=u'\\1 \\2 \\3 \\4', leading_digits_pattern=['[1789]'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(\\d)(\\d{3})(\\d{3})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[89]'], national_prefix_formatting_rule=u'0\\1')])
