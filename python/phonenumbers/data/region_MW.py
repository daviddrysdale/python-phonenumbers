...
PHONE_METADATA_MW = PhoneMetadata(id='MW', country_code=265, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:1(?:\\d{2})?|[2789]\\d{2})\\d{6}', possible_number_pattern='\\d{7,9}', possible_length=[9,7]),
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1[2-9]|21\\d{2})\\d{5}', possible_number_pattern='\\d{7,9}', example_number='1234567', possible_length=[7,9]),
