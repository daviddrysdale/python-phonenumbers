...
PHONE_METADATA_MW = PhoneMetadata(id='MW', country_code=265, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:111|(?:77|88|99)\\d)\\d{6}', example_number='991234567', possible_length=(9,)),
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['1[2-9]'], national_prefix_formatting_rule='0\\1'),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{2})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['[179]|88'], national_prefix_formatting_rule='0\\1'),
