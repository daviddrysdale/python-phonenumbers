...
PHONE_METADATA_MW = PhoneMetadata(id='MW', country_code=265, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern=u'(?:[13-5]|[27]\d{2}|[89](?:\d{2})?)\d{6}', possible_number_pattern=u'\d{7,9}'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'(?:1[2-9]|21\d{2})\d{5}', possible_number_pattern=u'\d{7,9}', example_number=u'1234567'),
    mobile=PhoneNumberDesc(national_number_pattern=u'(?:[3-5]|77|8(?:8\d)?|9(?:9\d)?)\d{6}', possible_number_pattern=u'\d{7,9}', example_number=u'991234567'),
