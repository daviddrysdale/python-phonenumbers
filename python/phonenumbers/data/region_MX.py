...
PHONE_METADATA_MX = PhoneMetadata(id='MX', country_code=52, international_prefix='0[09]',
    ...
    number_format=[NumberFormat(pattern='([358]\\d)(\\d{4})(\\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['33|55|81'], national_prefix_formatting_rule=u'01 \\1'),
        ...
        NumberFormat(pattern='(1)([358]\\d)(\\d{4})(\\d{4})', format=u'044 \\2 \\3 \\4', leading_digits_pattern=['1(?:33|55|81)'], national_prefix_formatting_rule=u'\\1'),
        NumberFormat(pattern='(1)(\\d{3})(\\d{3})(\\d{4})', format=u'044 \\2 \\3 \\4', leading_digits_pattern=['1(?:[2467]|3[12457-9]|5[89]|8[2-9]|9[1-35-9])'], national_prefix_formatting_rule=u'\\1')],
