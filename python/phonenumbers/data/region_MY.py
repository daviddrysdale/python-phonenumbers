...
PHONE_METADATA_MY = PhoneMetadata(id='MY', country_code=60, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='1(?:[02-46-9][2-9]|11\\d)\\d{6}', possible_number_pattern='\\d{9,10}', example_number='123456789'),
    ...
    number_format=[NumberFormat(pattern='([4-79])(\\d{3})(\\d{4})', format='\\1-\\2 \\3', leading_digits_pattern=['[4-79]'], national_prefix_formatting_rule='0\\1'),
        ...
        NumberFormat(pattern='(154)(\\d{3})(\\d{4})', format='\\1-\\2 \\3', leading_digits_pattern=['15'], national_prefix_formatting_rule='0\\1')])
