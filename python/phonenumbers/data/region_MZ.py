...
PHONE_METADATA_MZ = PhoneMetadata(id='MZ', country_code=258, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='8[246]\\d{7}', possible_number_pattern='\\d{9}', example_number='821234567'),
    ...
    number_format=[NumberFormat(pattern='([28]\\d)(\\d{3})(\\d{3,4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['2|8[246]']),
