...
PHONE_METADATA_NC = PhoneMetadata(id='NC', country_code=687, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:2[03-9]|3[0-5]|4[1-7]|88)\\d{4}', possible_number_pattern='\\d{6}', example_number='201234', possible_length=(6,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:5[0-4]|[79]\\d|8[0-79])\\d{4}', possible_number_pattern='\\d{6}', example_number='751234', possible_length=(6,)),
