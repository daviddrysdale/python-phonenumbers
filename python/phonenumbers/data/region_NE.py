...
PHONE_METADATA_NE = PhoneMetadata(id='NE', country_code=227, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:89|9[0-46-9])\\d{6}', possible_number_pattern='\\d{8}', example_number='93123456'),
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{2})(\\d{2})(\\d{2})', format=u'\\1 \\2 \\3 \\4', leading_digits_pattern=['[289]|09']),
