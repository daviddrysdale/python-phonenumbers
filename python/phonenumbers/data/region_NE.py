...
PHONE_METADATA_NE = PhoneMetadata(id='NE', country_code=227, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[0289]\\d{7}', possible_number_pattern='\\d{8}', possible_length=(8,)),
    fixed_line=PhoneNumberDesc(national_number_pattern='2(?:0(?:20|3[1-7]|4[134]|5[14]|6[14578]|7[1-578])|1(?:4[145]|5[14]|6[14-68]|7[169]|88))\\d{4}', possible_number_pattern='\\d{8}', example_number='20201234', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:8[089]|9\\d)\\d{6}', possible_number_pattern='\\d{8}', example_number='93123456', possible_length=(8,)),
