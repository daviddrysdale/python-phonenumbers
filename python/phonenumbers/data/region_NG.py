...
PHONE_METADATA_NG = PhoneMetadata(id='NG', country_code=234, international_prefix='009',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:707[0-3]|8(?:01|19)[01])\\d{6}|(?:70[1-689]|8(?:0[2-9]|1[0-8])|90[235-9])\\d{7}', example_number='8021234567', possible_length=(10,)),
