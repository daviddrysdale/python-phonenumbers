...
PHONE_METADATA_NG = PhoneMetadata(id='NG', country_code=234, international_prefix='009',
    general_desc=PhoneNumberDesc(national_number_pattern='[1-6]\\d{5,8}|9\\d{5,9}|[78]\\d{5,13}', possible_number_pattern='\\d{5,14}', possible_length=(7, 8, 10, 11, 12, 13, 14), possible_length_local_only=(5, 6)),
