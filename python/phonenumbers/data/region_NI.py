...
PHONE_METADATA_NI = PhoneMetadata(id='NI', country_code=505, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='5(?:5[0-7]\\d{5}|[78]\\d{6})|7[5-8]\\d{6}|8\\d{7}', possible_number_pattern='\\d{8}', example_number='81234567', possible_length=(8,)),
