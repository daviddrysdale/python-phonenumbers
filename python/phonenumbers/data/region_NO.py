...
PHONE_METADATA_NO = PhoneMetadata(id='NO', country_code=47, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern=u'0\d{4}|[2-9]\d{7}', possible_number_pattern=u'\d{5}(?:\d{3})?'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'(?:2[1-4]|3[1-3578]|5[1-35-7]|6[1-4679]|7[0-8])\d{6}', possible_number_pattern=u'\d{8}', example_number=u'21234567'),
