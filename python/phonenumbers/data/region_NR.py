...
PHONE_METADATA_NR = PhoneMetadata(id='NR', country_code=674, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:444|888)\\d{4}', possible_number_pattern='\\d{7}', example_number='4441234', possible_length=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='55[5-9]\\d{4}', possible_number_pattern='\\d{7}', example_number='5551234', possible_length=(7,)),
