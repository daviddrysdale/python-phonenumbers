...
PHONE_METADATA_NZ = PhoneMetadata(id='NZ', country_code=64, international_prefix='0(?:0|161)',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:3[2-79]|[49][2-689]|6[235-9]|7[2-5789])\\d{6}|24099\\d{3}', possible_number_pattern='\\d{7,8}', example_number='32345678'),
    mobile=PhoneNumberDesc(national_number_pattern='2(?:[028]\\d{7,8}|1(?:0\\d{5,7}|[12]\\d{5,6}|[3-9]\\d{5})|[79]\\d{7})', possible_number_pattern='\\d{8,10}', example_number='211234567'),
    ...
    number_format=[NumberFormat(pattern='([34679])(\\d{3})(\\d{4})', format='\\1-\\2 \\3', leading_digits_pattern=['[3467]|9[1-9]'], national_prefix_formatting_rule='0\\1'),
        ...
        NumberFormat(pattern='(\\d{2})(\\d{3})(\\d{3,4})', format='\\1 \\2 \\3', leading_digits_pattern=['2(?:1[1-9]|[69]|7[0-35-9])|86'], national_prefix_formatting_rule='0\\1'),
