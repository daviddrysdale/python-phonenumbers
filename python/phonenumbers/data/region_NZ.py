...
PHONE_METADATA_NZ = PhoneMetadata(id='NZ', country_code=64, international_prefix='0(?:0|161)',
    general_desc=PhoneNumberDesc(national_number_pattern='6[235-9]\\d{6}|[2-57-9]\\d{7,10}', possible_length=(8, 9, 10, 11), possible_length_local_only=(7,)),
    ...
    premium_rate=PhoneNumberDesc(national_number_pattern='90\\d{7,9}', example_number='900123456', possible_length=(9, 10, 11)),
