...
PHONE_METADATA_OM = PhoneMetadata(id='OM', country_code=968, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:2[2-6]|5|9\\d)\\d{6}|800\\d{5,6}', possible_number_pattern='\\d{7,9}'),
    fixed_line=PhoneNumberDesc(national_number_pattern='2[2-6]\\d{6}', possible_number_pattern='\\d{8}', example_number='23123456'),
    mobile=PhoneNumberDesc(national_number_pattern='9(?:0[1-9]|[1-9]\\d)\\d{5}', possible_number_pattern='\\d{8}', example_number='92123456'),
