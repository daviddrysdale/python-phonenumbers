...
PHONE_METADATA_PA = PhoneMetadata(id='PA', country_code=507, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='8\\d{9}|[68]\\d{7}|[1-57-9]\\d{6}', possible_length=(7, 8, 10)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:1[16]1|21[89]|6(?:[02-9]\\d|1[0-7])\\d|8(?:1[01]|7[23]))\\d{4}', example_number='61234567', possible_length=(7, 8)),
    toll_free=PhoneNumberDesc(national_number_pattern='800\\d{4}(?:\\d(?:\\d{2})?)?', example_number='8001234', possible_length=(7, 8, 10)),
