...
PHONE_METADATA_PA = PhoneMetadata(id='PA', country_code=507, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:1[16]1|21[89]|8(?:1[01]|7[23]))\\d{4}|6(?:[024-9]\\d|1[0-5]|3[04-9])\\d{5}', possible_number_pattern='\\d{7,8}', example_number='60012345'),
