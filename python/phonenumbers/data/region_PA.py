...
PHONE_METADATA_PA = PhoneMetadata(id='PA', country_code=507, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:6|8\\d\\d)\\d{7}|[1-57-9]\\d{6}', possible_length=(7, 8, 10)),
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='800\\d{4}(?:\\d{3})?', example_number='8001234', possible_length=(7, 10)),
