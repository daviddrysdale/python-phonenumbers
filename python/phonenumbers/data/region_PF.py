...
PHONE_METADATA_PF = PhoneMetadata(id='PF', country_code=689, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='4\\d{5,7}|8\\d{7}', possible_number_pattern='\\d{6}(?:\\d{2})?', possible_length=[8,6]),
    fixed_line=PhoneNumberDesc(national_number_pattern='4(?:[09][45689]\\d|4)\\d{4}', possible_number_pattern='\\d{6}(?:\\d{2})?', example_number='40412345', possible_length=[6,8]),
