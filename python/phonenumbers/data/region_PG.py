...
PHONE_METADATA_PG = PhoneMetadata(id='PG', country_code=675, international_prefix='00|140[1-3]',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:7\\d|8[1-58])\\d{6}', example_number='70123456', possible_length=(8,)),
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{4})', format='\\1 \\2', leading_digits_pattern=['18|[2-69]|85[02-46-9]']),
