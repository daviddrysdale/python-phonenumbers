...
PHONE_METADATA_PG = PhoneMetadata(id='PG', country_code=675, international_prefix='00|140[1-3]',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:(?:3[0-2]|4[257]|5[34]|9[78])\\d|64[1-9]|77(?:[0-24]\\d|30)|85[02-46-9])\\d{4}', example_number='3123456', possible_length=(7, 8)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:7(?:[0-689]\\d|75)|81\\d)\\d{5}', example_number='70123456', possible_length=(8,)),
