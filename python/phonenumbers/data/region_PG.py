...
PHONE_METADATA_PG = PhoneMetadata(id='PG', country_code=675, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:68|7[0-36]\\d)\\d{5}', possible_number_pattern='\\d{7,8}', example_number='6812345'),
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{4})', format=u'\\1 \\2', leading_digits_pattern=['[1-689]']),
        NumberFormat(pattern='(7\\d{2})(\\d{2})(\\d{3})', format=u'\\1 \\2 \\3', leading_digits_pattern=['7'])])
