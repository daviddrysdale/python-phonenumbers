...
PHONE_METADATA_PG = PhoneMetadata(id='PG', country_code=675, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:3[0-2]\\d|4[25]\\d|5[34]\\d|64[1-9]|77(?:[0-24]\\d|30)|85[02-46-9]|9[78]\\d)\\d{4}', possible_number_pattern='\\d{7}', example_number='3123456', possible_length=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:20150|68\\d{2}|7(?:[0-689]\\d|75)\\d{2})\\d{3}', possible_number_pattern='\\d{7,8}', example_number='6812345', possible_length=(7, 8)),
    ...
    voip=PhoneNumberDesc(national_number_pattern='275\\d{4}', possible_number_pattern='\\d{7}', example_number='2751234', possible_length=(7,)),
