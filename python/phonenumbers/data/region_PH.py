...
PHONE_METADATA_PH = PhoneMetadata(id='PH', country_code=63, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern=u'[2-9]\d{7,9}|1800\d{7,9}', possible_number_pattern=u'\d{7,13}'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'(?:2|3[2-68]|4[2-9]|5[2-6]|6[2-58]|7[24578]|8[2-8])\d{7}', possible_number_pattern=u'\d{7,9}', example_number=u'21234567'),
    mobile=PhoneNumberDesc(national_number_pattern=u'9(?:0[5-9]|1[025-9]|2[0-36-9]|3[0235-9]|7[349]|[89]9)\d{7}', possible_number_pattern=u'\d{10}', example_number=u'9051234567'),
    toll_free=PhoneNumberDesc(national_number_pattern=u'1800\d{7,9}', possible_number_pattern=u'\d{11,13}', example_number=u'180012345678'),
