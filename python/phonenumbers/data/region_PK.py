...
PHONE_METADATA_PK = PhoneMetadata(id='PK', country_code=92, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern=u'1\d{8}|[2-8]\d{5,11}|9(?:[013-9]\d{4,9}|2\d(?:111\d{6}|\d{3,7}))', possible_number_pattern=u'\d{6,12}'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'(?:21|42)[2-9]\d{7}|(?:2[25]|4[0146-9]|5[1-35-7]|6[1-8]|7[14]|8[16]|91)[2-9]\d{6}|(?:2(?:3[2358]|4[2-4]|9[2-8])|45[3479]|54[2-467]|60[468]|72[236]|8(?:2[2-689]|3[23578]|4[3478]|5[2356])|9(?:1|2[2-8]|3[27-9]|4[2-6]|6[3569]|9[25-8]))[2-9]\d{5,6}|58[126]\d{7}', possible_number_pattern=u'\d{6,10}', example_number=u'2123456789'),
    mobile=PhoneNumberDesc(national_number_pattern=u'3(?:0\d|1[2-5]|2[1-3]|3[1-6]|4[2-7]|64)\d{7}', possible_number_pattern=u'\d{10}', example_number=u'3012345678'),
    ...
    personal_number=PhoneNumberDesc(national_number_pattern=u'122\d{6}', possible_number_pattern=u'\d{9}', example_number=u'122044444'),
    voip=PhoneNumberDesc(national_number_pattern=u'NA', possible_number_pattern=u'NA'),
    pager=PhoneNumberDesc(national_number_pattern=u'NA', possible_number_pattern=u'NA'),
    uan=PhoneNumberDesc(national_number_pattern=u'(?:2(?:[125]|3[2358]|4[2-4]|9[2-8])|4(?:[0-246-9]|5[3479])|5(?:[1-35-7]|4[2-467])|6(?:[1-8]|0[468])|7(?:[14]|2[236])|8(?:[16]|2[2-689]|3[23578]|4[3478]|5[2356])|9(?:1|22|3[27-9]|4[2-6]|6[3569]|9[2-7]))111\d{6}', possible_number_pattern=u'\d{11,12}', example_number=u'21111825888'),
