...
PHONE_METADATA_PK = PhoneMetadata(id='PK', country_code=92, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='3(?:0\\d|1[0-6]|2[0-5]|3[0-7]|4[0-8]|55|64)\\d{7}', possible_number_pattern='\\d{10}', example_number='3012345678', possible_length=(10,)),
