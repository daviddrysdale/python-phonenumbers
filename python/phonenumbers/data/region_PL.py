...
PHONE_METADATA_PL = PhoneMetadata(id='PL', country_code=48, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1[2-8]|2[2-59]|3[2-4]|4[1-468]|5[24-689]|6[1-3578]|7[14-7]|8[1-79]|9[145])\\d{7}|[12]2\\d{5}|261\\d{6}', possible_number_pattern='\\d{6,9}', example_number='123456789'),
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{3})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['[14]|2[0-57-9]|3[2-4]|5[24-689]|6[1-3578]|7[14-7]|8[1-79]|9[145]']),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['261|39|5[0137]|6[0469]|7[02389]|8[08]']),
