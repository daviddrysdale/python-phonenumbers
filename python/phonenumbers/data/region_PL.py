...
PHONE_METADATA_PL = PhoneMetadata(id='PL', country_code=48, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:5[013]|6[069]|7[2389]|88)\\d{7}', possible_number_pattern='\\d{9}', example_number='512345678'),
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{3})(\\d{2})(\\d{2})', format=u'\\1 \\2 \\3 \\4', leading_digits_pattern=['[124]|3[2-4]|5[24-689]|6[1-3578]|7[14-7]|8[1-79]|9[145]']),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{3})', format=u'\\1 \\2 \\3', leading_digits_pattern=['39|5[013]|6[0469]|7[02389]|8[08]']),
