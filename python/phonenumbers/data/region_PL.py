...
PHONE_METADATA_PL = PhoneMetadata(id='PL', country_code=48, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1[2-8]|2[2-69]|3[2-4]|4[1-468]|5[24-689]|6[1-3578]|7[14-7]|8[1-79]|9[145])\\d{7}|[12]2\\d{5}', example_number='123456789', possible_length=(7, 9)),
