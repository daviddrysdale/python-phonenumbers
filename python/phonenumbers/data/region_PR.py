...
PHONE_METADATA_PR = PhoneMetadata(id='PR', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:787|939)[2-9]\\d{6}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='7872345678', possible_length=(10,), possible_length_local_only=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:787|939)[2-9]\\d{6}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='7872345678', possible_length=(10,), possible_length_local_only=(7,)),
