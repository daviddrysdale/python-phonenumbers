...
PHONE_METADATA_PY = PhoneMetadata(id='PY', country_code=595, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='9(?:61|7[12356]|8[1-5]|9[1235])\\d{6}', possible_number_pattern='\\d{9}', example_number='961456789'),
    ...
    uan=PhoneNumberDesc(national_number_pattern='[2-9]0\\d{4,7}', possible_number_pattern='\\d{5,9}', example_number='201234567'),
