...
PHONE_METADATA_PY = PhoneMetadata(id='PY', country_code=595, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='9\\d{10}|(?:[2-46-9]\\d|5[0-8])\\d{7}|[2-9]\\d{5,7}', possible_length=(6, 7, 8, 9, 11), possible_length_local_only=(5,)),
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='9800\\d{7}', example_number='98000123456', possible_length=(11,)),
