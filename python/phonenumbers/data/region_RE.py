...
PHONE_METADATA_RE = PhoneMetadata(id='RE', country_code=262, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='26(?:2\\d\\d|30[01])\\d{4}', example_number='262161234', possible_length=(9,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:69(?:2\\d\\d|3(?:0[0-46]|1[013]|2[0-2]|3[0-39]|4\\d|5[05]|6[0-26]|7[0-27]|8[03-8]|9[0-479]))|9769\\d)\\d{4}', example_number='692123456', possible_length=(9,)),
