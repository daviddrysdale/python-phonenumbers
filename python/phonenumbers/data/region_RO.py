...
PHONE_METADATA_RO = PhoneMetadata(id='RO', country_code=40, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:[2378]\\d|62|90)\\d{7}|[23]\\d{5}', possible_length=(6, 9)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='7020\\d{5}|(?:62\\d|7(?:0[013-9]|1[0-3]|[2-7]\\d|8[03-8]|9[0-39]))\\d{6}', example_number='712034567', possible_length=(9,)),
