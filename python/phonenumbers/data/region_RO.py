...
PHONE_METADATA_RO = PhoneMetadata(id='RO', country_code=40, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='7(?:000|[1-8]\\d{2}|99\\d)\\d{5}', possible_number_pattern='\\d{9}', example_number='712345678'),
    ...
    number_format=[NumberFormat(pattern='([237]\\d)(\\d{3})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['[23]1'], national_prefix_formatting_rule='0\\1'),
