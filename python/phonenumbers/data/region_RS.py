...
PHONE_METADATA_RS = PhoneMetadata(id='RS', country_code=381, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern=u'[1-46-9]\d{4,11}', possible_number_pattern=u'\d{5,12}'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'[1-3]\d{6,9}', possible_number_pattern=u'\d{5,10}', example_number=u'1012345'),
    mobile=PhoneNumberDesc(national_number_pattern=u'6[0-689]\d{3,10}', possible_number_pattern=u'\d{5,12}', example_number=u'6012345'),
    toll_free=PhoneNumberDesc(national_number_pattern=u'800\d{3,6}', possible_number_pattern=u'\d{6,9}', example_number=u'80012345'),
    premium_rate=PhoneNumberDesc(national_number_pattern=u'(?:9[0-2]|42)\d{4,7}', possible_number_pattern=u'\d{6,9}', example_number=u'90012345'),
