...
PHONE_METADATA_RU = PhoneMetadata(id='RU', country_code=7, international_prefix='810',
    ...
    number_format=[NumberFormat(pattern='([3489]\\d{2})(\\d{3})(\\d{2})(\\d{2})', format='\\1 \\2-\\3-\\4', leading_digits_pattern=['[34689]'], national_prefix_formatting_rule='8 (\\1)', national_prefix_optional_when_formatting=True),
