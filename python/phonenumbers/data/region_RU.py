...
PHONE_METADATA_RU = PhoneMetadata(id='RU', country_code=7, international_prefix='810',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:3(?:0[12]|4[1-35-79]|5[1-3]|65|8[1-58]|9[0145])|4(?:01|1[1356]|2[13467]|7[1-5]|8[1-7]|9[1-689])|8(?:1[1-8]|2[01]|3[13-6]|4[0-8]|5[15]|6[1-35-79]|7[1-37-9]))\\d{7}', possible_number_pattern='\\d{10}', example_number='3011234567', possible_length=(10,)),
    mobile=PhoneNumberDesc(national_number_pattern='9\\d{9}', possible_number_pattern='\\d{10}', example_number='9123456789', possible_length=(10,)),
