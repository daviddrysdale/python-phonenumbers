...
PHONE_METADATA_SA = PhoneMetadata(id='SA', country_code=966, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:11?\\d|1?(?:2[24-8]|3[35-8]|4[3-68]|6[2-5]|7[235-7]))\\d{6}', possible_number_pattern='\\d{7,9}', example_number='112345678'),
    ...
    number_format=[NumberFormat(pattern='([1-467])(\\d{3})(\\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[1-467]'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(1\\d)(\\d{3})(\\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['1[1-467]'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(5\\d)(\\d{3})(\\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['5'], national_prefix_formatting_rule=u'0\\1'),
        NumberFormat(pattern='(92\\d{2})(\\d{5})', format=u'\\1 \\2', leading_digits_pattern=['9'], national_prefix_formatting_rule=u'\\1'),
