...
PHONE_METADATA_SB = PhoneMetadata(id='SB', country_code=677, international_prefix='0[01]',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:48|99[0-8]\\d)\\d{3}|(?:6[89]|7[1-9]|8[4-9]|9[0-8])\\d{5}', example_number='7421234', possible_length=(5, 7)),
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{5})', format='\\1 \\2', leading_digits_pattern=['6[89]|7|8[4-9]|9(?:[0-8]|9[0-8])'])])
