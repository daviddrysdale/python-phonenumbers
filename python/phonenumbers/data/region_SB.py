...
PHONE_METADATA_SB = PhoneMetadata(id='SB', country_code=677, international_prefix='0[01]',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='48\\d{3}|7(?:[0146-8]\\d|5[025-9]|9[04])\\d{4}|8[4-8]\\d{5}|9(?:[46]\\d|5[0-46-9]|7[0-689]|8[0-79]|9[0-8])\\d{4}', possible_number_pattern='\\d{5,7}', example_number='7421234'),
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{4})', format='\\1 \\2', leading_digits_pattern=['[7-9]'])])
