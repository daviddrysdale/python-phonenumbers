...
PHONE_METADATA_SB = PhoneMetadata(id='SB', country_code=677, international_prefix='0[01]',
    general_desc=PhoneNumberDesc(national_number_pattern='[1-9]\\d{4,6}', possible_number_pattern='\\d{5,7}', possible_length=(5, 7)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='48\\d{3}|7(?:30|[46-8]\\d|5[025-9]|9[0-5])\\d{4}|8[4-9]\\d{5}|9(?:1[2-9]|2[013-9]|3[0-2]|[46]\\d|5[0-46-9]|7[0-689]|8[0-79]|9[0-8])\\d{4}', possible_number_pattern='\\d{5,7}', example_number='7421234', possible_length=(5, 7)),
