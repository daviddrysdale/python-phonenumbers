...
PHONE_METADATA_SC = PhoneMetadata(id='SC', country_code=248, international_prefix='0(?:[02]|10?)',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:(?:[249]\\d|64)\\d\\d|8000)\\d{3}', possible_length=(7,)),
    ...
    voip=PhoneNumberDesc(national_number_pattern='(?:64\\d|9(?:5\\d|71))\\d{4}', example_number='6412345', possible_length=(7,)),
