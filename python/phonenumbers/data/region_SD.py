...
PHONE_METADATA_SD = PhoneMetadata(id='SD', country_code=249, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='1(?:[125]\\d|8[3567])\\d{6}', possible_number_pattern='\\d{9}', example_number='121231234', possible_length=(9,)),
    mobile=PhoneNumberDesc(national_number_pattern='9[0-3569]\\d{7}', possible_number_pattern='\\d{9}', example_number='911231234', possible_length=(9,)),
