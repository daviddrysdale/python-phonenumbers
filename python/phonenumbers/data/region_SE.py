...
PHONE_METADATA_SE = PhoneMetadata(id='SE', country_code=46, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='(8)(\\d{2,3})(\\d{2,3})(\\d{2})', format=u'\\1-\\2 \\3 \\4', leading_digits_pattern=['8'], national_prefix_formatting_rule=u'0\\1'),
        ...
        NumberFormat(pattern='(77)(\\d{2})(\\d{2})', format=u'\\1-\\2\\3', leading_digits_pattern=['7'], national_prefix_formatting_rule=u'0\\1'),
        ...
        NumberFormat(pattern='(9[034]\\d)(\\d{4})', format=u'\\1-\\2', leading_digits_pattern=['9[034]'], national_prefix_formatting_rule=u'0\\1')],
