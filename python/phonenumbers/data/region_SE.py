...
PHONE_METADATA_SE = PhoneMetadata(id='SE', country_code=46, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:[26]\\d\\d|9)\\d{9}|[1-9]\\d{8}|[1-689]\\d{7}|[1-4689]\\d{6}|[27]\\d{5}', possible_length=(6, 7, 8, 9, 10, 12)),
    ...
    number_format=[NumberFormat(pattern='([1-469]\\d)(\\d{3})(\\d{2})', format='\\1-\\2 \\3', leading_digits_pattern=['[12][136]|3[356]|4[0246]|6[03]|90[1-9]'], national_prefix_formatting_rule='0\\1'),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{2})(\\d{3})(\\d{2})(\\d{2})', format='\\1-\\2 \\3 \\4 \\5', leading_digits_pattern=['25[245]|67[3-68]'], national_prefix_formatting_rule='0\\1')],
    intl_number_format=[NumberFormat(pattern='([1-469]\\d)(\\d{3})(\\d{2})', format='\\1 \\2 \\3', leading_digits_pattern=['[12][136]|3[356]|4[0246]|6[03]|90[1-9]']),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{2})(\\d{3})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4 \\5', leading_digits_pattern=['25[245]|67[3-68]'])],
