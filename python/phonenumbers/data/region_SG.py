...
PHONE_METADATA_SG = PhoneMetadata(id='SG', country_code=65, international_prefix='0[0-3]\\d',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:8(?:[1-8]\\d\\d|9(?:[01]\\d|2[4-8]|3[0-4]))|9[0-8]\\d\\d)\\d{4}', example_number='81234567', possible_length=(8,)),
    ...
    voip=PhoneNumberDesc(national_number_pattern='(?:3[12]\\d\\d|6666)\\d{4}', example_number='31234567', possible_length=(8,)),
