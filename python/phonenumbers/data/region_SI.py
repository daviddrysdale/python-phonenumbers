...
PHONE_METADATA_SI = PhoneMetadata(id='SI', country_code=386, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1\\d|[25][2-8]|3[4-8]|4[24-8]|7[3-8])\\d{6}', possible_number_pattern='\\d{7,8}', example_number='11234567'),
    mobile=PhoneNumberDesc(national_number_pattern='(?:[37][01]|4[019]|51|6[48])\\d{6}', possible_number_pattern='\\d{8}', example_number='31234567'),
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{3})(\\d{2})(\\d{2})', format=u'\\1 \\2 \\3 \\4', leading_digits_pattern=['[12]|3[4-8]|4[24-8]|5[2-8]|7[3-8]'], national_prefix_formatting_rule=u'(0\\1)'),
        NumberFormat(pattern='([3-7]\\d)(\\d{3})(\\d{3})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[37][01]|4[019]|51|6'], national_prefix_formatting_rule=u'0\\1'),
