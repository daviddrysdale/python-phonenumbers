...
PHONE_METADATA_SI = PhoneMetadata(id='SI', country_code=386, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{3})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['[12]|3[4-8]|4[24-8]|5[3-8]|7[3-8]'], national_prefix_formatting_rule='(0\\1)'),
        NumberFormat(pattern='([3-7]\\d)(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['[37][01]|4[019]|51|64'], national_prefix_formatting_rule='0\\1'),
