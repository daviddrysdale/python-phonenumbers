...
PHONE_METADATA_SK = PhoneMetadata(id='SK', country_code=421, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2(?:1(?:6\\d{3,4}|7\\d{3})|[2-9]\\d{7})|[3-5][1-8](?:16\\d{2,3}|\\d{7})', possible_number_pattern='\\d{6,9}', example_number='221234567', possible_length=(6, 7, 9)),
