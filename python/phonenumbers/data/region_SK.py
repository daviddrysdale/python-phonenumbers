...
PHONE_METADATA_SK = PhoneMetadata(id='SK', country_code=421, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:[2-68]\\d{5,8}|9\\d{6,8})', possible_number_pattern='\\d{6,9}', possible_length=(6, 7, 9)),
    fixed_line=PhoneNumberDesc(national_number_pattern='2(?:1(?:6\\d{3,4}|7\\d{3})|[2-9]\\d{7})|[3-5][1-8](?:1(?:6\\d{2,3}|7\\d{3})|\\d{7})', possible_number_pattern='\\d{6,9}', example_number='221234567', possible_length=(6, 7, 9)),
    mobile=PhoneNumberDesc(national_number_pattern='9(?:0(?:[1-8]\\d|9[1-9])|(?:1[0-24-9]|[45]\\d)\\d)\\d{5}', possible_number_pattern='\\d{9}', example_number='912123456', possible_length=(9,)),
