...
PHONE_METADATA_SL = PhoneMetadata(id='SL', country_code=232, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[2-57-9]\\d{7}', possible_number_pattern='\\d{6,8}'),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:2[15]|3[034]|4[04]|5[05]|7[6-9]|88|99)\\d{6}', possible_number_pattern='\\d{6,8}', example_number='25123456'),
