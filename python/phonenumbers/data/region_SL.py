...
PHONE_METADATA_SL = PhoneMetadata(id='SL', country_code=232, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='[235]2[2-4][2-9]\\d{4}', possible_number_pattern='\\d{6,8}', example_number='22221234', possible_length=(8,), possible_length_local_only=(6,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:2[15]|3[03-5]|4[04]|5[05]|66|7[6-9]|88|99)\\d{6}', possible_number_pattern='\\d{6,8}', example_number='25123456', possible_length=(8,)),
