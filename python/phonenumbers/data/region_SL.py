...
PHONE_METADATA_SL = PhoneMetadata(id='SL', country_code=232, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:[2378]\\d|66|99)\\d{6}', possible_length=(8,), possible_length_local_only=(6,)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:25|3[013-5]|66|7[4-9]|8[08]|99)\\d{6}', example_number='25123456', possible_length=(8,)),
    national_prefix='0',
