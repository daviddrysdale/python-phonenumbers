...
PHONE_METADATA_SM = PhoneMetadata(id='SM', country_code=378, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='0549(?:8[0157-9]|9\\d)\\d{4}', possible_number_pattern='\\d{6,10}', example_number='0549886377', possible_length=(10,), possible_length_local_only=(6,)),
