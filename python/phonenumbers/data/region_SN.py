...
PHONE_METADATA_SN = PhoneMetadata(id='SN', country_code=221, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='3(?:0(?:1[0-2]|80)|2(?:11|82)|3(?:8[1-9]|9[3-9])|90[1-5])\\d{5}', possible_number_pattern='\\d{9}', example_number='301012345'),
    mobile=PhoneNumberDesc(national_number_pattern='7(?:[067]\\d|8[0-26]|90)\\d{6}', possible_number_pattern='\\d{9}', example_number='701234567'),
