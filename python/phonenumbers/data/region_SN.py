...
PHONE_METADATA_SN = PhoneMetadata(id='SN', country_code=221, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='7(?:0[1256]0|6(?:1[23]|2[89]|3[3489]|4[6-9]|5[1-389]|6[6-9]|7[45]|8[3-8])|7(?:1[014-8]|2[0-7]|3[0-35-8]|4[0-6]|[56]\\d|7[0-589]|8[01]|9[0-6]))\\d{5}', possible_number_pattern='\\d{9}', example_number='701012345'),
