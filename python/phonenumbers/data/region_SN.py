...
PHONE_METADATA_SN = PhoneMetadata(id='SN', country_code=221, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='7(?:0[1256]0|6(?:1[23]|2[89]|3[3489]|4[6-9]|5[1-389]|6[5-9]|7[45]|8[3-8])|7(?:01|1[014-8]|[2-79]\\d|8[019]))\\d{5}', possible_number_pattern='\\d{9}', example_number='701012345'),
