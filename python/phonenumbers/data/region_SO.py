...
PHONE_METADATA_SO = PhoneMetadata(id='SO', country_code=252, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:15\\d|2(?:4\\d|8)|6[17-9]?\\d{2}|7\\d{2}|9(?:07|[19])\\d)\\d{5}', possible_number_pattern='\\d{7,9}', example_number='907792024'),
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{6})', format=u'\\1 \\2', leading_digits_pattern=['2[0-79]|[13-5]']),
        ...
        NumberFormat(pattern='(\\d{2})(\\d{5,7})', format=u'\\1 \\2', leading_digits_pattern=['15|28|6[178]|9']),
