...
PHONE_METADATA_SO = PhoneMetadata(id='SO', country_code=252, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:(?:15|(?:3[59]|4[89]|6[1-9]|79|8[08])\\d|9(?:0[67]|[2-9]))\\d|2(?:4\\d|8))\\d{5}|(?:6\\d|7[1-9])\\d{6}', example_number='71123456', possible_length=(7, 8, 9)),
    national_prefix='0',
