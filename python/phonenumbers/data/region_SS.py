...
PHONE_METADATA_SS = PhoneMetadata(id='SS', country_code=211, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='18\\d{7}', possible_number_pattern='\\d{9}', example_number='181234567', possible_length=(9,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:12|9[1257])\\d{7}', possible_number_pattern='\\d{9}', example_number='977123456', possible_length=(9,)),
