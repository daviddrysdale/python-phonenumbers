...
PHONE_METADATA_ST = PhoneMetadata(id='ST', country_code=239, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='22\\d{5}', possible_number_pattern='\\d{7}', example_number='2221234', possible_length=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='9(?:0(?:0[5-9]|[1-9]\\d)|[89]\\d{2})\\d{3}', possible_number_pattern='\\d{7}', example_number='9812345', possible_length=(7,)),
