...
PHONE_METADATA_SX = PhoneMetadata(id='SX', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='7215(?:4[2-8]|8[239])\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='7215425678'),
    mobile=PhoneNumberDesc(national_number_pattern='7215(?:1[02]|2\\d|5[03469]|8[01678])\\d{4}', possible_number_pattern='\\d{10}', example_number='7215205678'),
