...
PHONE_METADATA_SY = PhoneMetadata(id='SY', country_code=963, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1(?:1\\d?|4\\d|[2356])|2[1-35]|3(?:1\\d|[34])|4[13]|5[1-3])\\d{6}', possible_number_pattern='\\d{6,9}', example_number='112345678'),
    mobile=PhoneNumberDesc(national_number_pattern='9(?:3[23]|4[457]|55|6[67]|88|9[19])\\d{6}', possible_number_pattern='\\d{9}', example_number='944567890'),
