...
PHONE_METADATA_SY = PhoneMetadata(id='SY', country_code=963, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1[14]\\d|2(?:1\\d?|[235])|3(?:[13]\\d|4)|4[13]|5[1-3])\\d{6}|1[1-356]\\d{6}', example_number='112345678', possible_length=(8, 9), possible_length_local_only=(6, 7)),
