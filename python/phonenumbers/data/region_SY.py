...
PHONE_METADATA_SY = PhoneMetadata(id='SY', country_code=963, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='9(?:22|3[1-356]|4\\d|5[024-7]|6[26-9]|88|9[0-489])\\d{6}', possible_number_pattern='\\d{9}', example_number='944567890'),
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{3})(\\d{3,4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[1-5]'], national_prefix_formatting_rule=u'0\\1', national_prefix_optional_when_formatting=True),
        NumberFormat(pattern='(9\\d{2})(\\d{3})(\\d{3})', format=u'\\1 \\2 \\3', leading_digits_pattern=['9'], national_prefix_formatting_rule=u'0\\1', national_prefix_optional_when_formatting=True)])
