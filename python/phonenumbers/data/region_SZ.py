...
PHONE_METADATA_SZ = PhoneMetadata(id='SZ', country_code=268, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2[2-5]\\d{6}', possible_number_pattern='\\d{8}', example_number='22171234', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='7[6-8]\\d{6}', possible_number_pattern='\\d{8}', example_number='76123456', possible_length=(8,)),
