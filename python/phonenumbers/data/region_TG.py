...
PHONE_METADATA_TG = PhoneMetadata(id='TG', country_code=228, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2(?:2[2-7]|3[23]|44|55|66|77)\\d{5}', possible_number_pattern='\\d{8}', example_number='22212345', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='9[0-389]\\d{6}', possible_number_pattern='\\d{8}', example_number='90112345', possible_length=(8,)),
