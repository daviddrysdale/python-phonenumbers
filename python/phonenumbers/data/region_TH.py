...
PHONE_METADATA_TH = PhoneMetadata(id='TH', country_code=66, international_prefix='00[1-9]',
    general_desc=PhoneNumberDesc(national_number_pattern='1\\d{9}|[1689]\\d{8}|[1-57]\\d{7}', possible_length=(8, 9, 10)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='671[0-3]\\d{5}|(?:14|6[1-6]|[89]\\d)\\d{7}', example_number='812345678', possible_length=(9,)),
