...
PHONE_METADATA_TH = PhoneMetadata(id='TH', country_code=66, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[2-9]\\d{7,8}|1\\d{3}(?:\\d{5,6})?', possible_length=(4, 8, 9, 10)),
    ...
    uan=PhoneNumberDesc(national_number_pattern='1\\d{3}', example_number='1100', possible_length=(4,)),
    no_international_dialling=PhoneNumberDesc(national_number_pattern='1\\d{3}', example_number='1100', possible_length=(4,)),
    national_prefix='0',
