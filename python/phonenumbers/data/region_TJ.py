...
PHONE_METADATA_TJ = PhoneMetadata(id='TJ', country_code=992, international_prefix='810',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:50[125]|9[0-35-9]\\d)\\d{6}', possible_number_pattern='\\d{9}', example_number='917123456'),
    ...
    number_format=[NumberFormat(pattern='([349]\\d{2})(\\d{2})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['[34]7|91[78]'], national_prefix_formatting_rule='(8) \\1', national_prefix_optional_when_formatting=True),
        NumberFormat(pattern='([459]\\d)(\\d{3})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['4[48]|5|9(?:1[59]|[0235-9])'], national_prefix_formatting_rule='(8) \\1', national_prefix_optional_when_formatting=True),
