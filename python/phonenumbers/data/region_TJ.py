...
PHONE_METADATA_TJ = PhoneMetadata(id='TJ', country_code=992, international_prefix='8~10',
    general_desc=PhoneNumberDesc(national_number_pattern=u'[3-59]\d{8}', possible_number_pattern=u'\d{3,9}'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'(?:3(?:1[3-5]|2[245]|3[12]|4[24-7]|5[25]|72)|4(?:46|74|87))\d{6}', possible_number_pattern=u'\d{3,9}', example_number=u'372123456'),
    mobile=PhoneNumberDesc(national_number_pattern=u'(?:505|9[0-35-9]\d)\d{6}', possible_number_pattern=u'\d{9}', example_number=u'917123456'),
    ...
    number_format=[NumberFormat(pattern='([349]\d{2})(\d{2})(\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[34]7|91[78]'], national_prefix_formatting_rule=u'(8) \\1'),
        NumberFormat(pattern='([459]\d)(\d{3})(\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['4[48]|5|9(?:19|[0235-9])'], national_prefix_formatting_rule=u'(8) \\1'),
