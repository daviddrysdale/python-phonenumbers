...
PHONE_METADATA_TJ = PhoneMetadata(id='TJ', country_code=992, international_prefix='810',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:00|11|[3-57-9]\\d)\\d{7}', possible_length=(9,), possible_length_local_only=(3, 5, 6, 7)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='41[18]\\d{6}|(?:[04]0|11|5[05]|7[07]|88|9\\d)\\d{7}', example_number='917123456', possible_length=(9,)),
