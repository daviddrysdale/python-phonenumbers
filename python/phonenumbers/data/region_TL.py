...
PHONE_METADATA_TL = PhoneMetadata(id='TL', country_code=670, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[2-489]\\d{6}|7\\d{6,7}', possible_number_pattern='\\d{7,8}', possible_length=(7, 8)),
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:2[1-5]|3[1-9]|4[1-4])\\d{5}', possible_number_pattern='\\d{7}', example_number='2112345', possible_length=(7,)),
