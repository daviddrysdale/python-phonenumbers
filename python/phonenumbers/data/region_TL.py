...
PHONE_METADATA_TL = PhoneMetadata(id='TL', country_code=670, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='7[78][1-9]\\d{5}', possible_number_pattern='\\d{8}', example_number='77212345'),
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{4})', format=u'\\1 \\2', leading_digits_pattern=['[2-489]']),
        NumberFormat(pattern='(\\d{4})(\\d{4})', format=u'\\1 \\2', leading_digits_pattern=['7'])])
