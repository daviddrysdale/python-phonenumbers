...
PHONE_METADATA_TN = PhoneMetadata(id='TN', country_code=216, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:(?:3[0-2]|7\\d)\\d{3}|81200)\\d{3}', example_number='30010123', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:(?:[259]\\d|4[0-6])\\d\\d|3(?:001|1(?:[1-35]\\d|40)|240|(?:6[0-4]|91)\\d))\\d{4}', example_number='20123456', possible_length=(8,)),
