...
PHONE_METADATA_TN = PhoneMetadata(id='TN', country_code=216, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='3[012]\\d{6}|7\\d{7}|81200\\d{3}', possible_number_pattern='\\d{8}', example_number='71234567'),
    mobile=PhoneNumberDesc(national_number_pattern='(?:[259]\\d|4[0-24])\\d{6}', possible_number_pattern='\\d{8}', example_number='20123456'),
