...
PHONE_METADATA_TO = PhoneMetadata(id='TO', country_code=676, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:55[56]|6(?:[09]\\d|3[02]|8[15-9])|(?:7\\d|8[46-9])\\d|999)\\d{4}', example_number='7715123', possible_length=(7,)),
    ...
    voip=PhoneNumberDesc(national_number_pattern='55[1-37-9]\\d{4}', example_number='5510123', possible_length=(7,)),
