...
PHONE_METADATA_TT = PhoneMetadata(id='TT', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='868(?:2(?:[03]1|2[1-5])|6(?:0[79]|1[02-8]|2[1-9]|[3-69]\\d|7[0-79])|82[124])\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='8682211234'),
