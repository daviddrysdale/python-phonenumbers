...
PHONE_METADATA_TW = PhoneMetadata(id='TW', country_code=886, international_prefix='0(?:0[25679]|19)',
    general_desc=PhoneNumberDesc(national_number_pattern='[2-689]\\d{7,8}|7\\d{7,9}', possible_number_pattern='\\d{8,10}', possible_length=(8, 9, 10)),
    fixed_line=PhoneNumberDesc(national_number_pattern='[2-8]\\d{7,8}', possible_number_pattern='\\d{8,9}', example_number='21234567', possible_length=(8, 9)),
