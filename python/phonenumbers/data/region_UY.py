...
PHONE_METADATA_UY = PhoneMetadata(id='UY', country_code=598, international_prefix='0(?:0|1[3-9]\\d)',
    general_desc=PhoneNumberDesc(national_number_pattern='0004\\d{2,9}|4\\d{9}|[1249]\\d{7}|(?:[49]\\d|80)\\d{5}', possible_length=(6, 7, 8, 9, 10, 11, 12, 13)),
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='0004\\d{2,9}|(?:4\\d{5}|80[05])\\d{4}|405\\d{4}', example_number='8001234', possible_length=(6, 7, 8, 9, 10, 11, 12, 13)),
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{3,4})', format='\\1 \\2', leading_digits_pattern=['0']),
        NumberFormat(pattern='(\\d{3})(\\d{4})', format='\\1 \\2', leading_digits_pattern=['405|8|90'], national_prefix_formatting_rule='0\\1'),
