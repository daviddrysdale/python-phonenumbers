...
PHONE_METADATA_UY = PhoneMetadata(id='UY', country_code=598, international_prefix='0(?:0|1[3-9]\\d)',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:(?:4\\d{3}|9)\\d|80)\\d{5}|[249]\\d{7}', possible_length=(7, 8, 10)),
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='(?:4\\d{5}|80[05])\\d{4}', example_number='8001234', possible_length=(7, 10)),
