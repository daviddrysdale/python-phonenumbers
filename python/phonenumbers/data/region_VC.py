...
PHONE_METADATA_VC = PhoneMetadata(id='VC', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='784(?:266|3(?:6[6-9]|7\\d|8[0-24-6])|4(?:38|5[0-36-8]|8[0-8])|5(?:55|7[0-2]|93)|638|784)\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='7842661234', possible_length=(10,), possible_length_local_only=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='784(?:4(?:3[0-4]|5[45]|89|9[0-58])|5(?:2[6-9]|3[0-4]))\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='7844301234', possible_length=(10,), possible_length_local_only=(7,)),
