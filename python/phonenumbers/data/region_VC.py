...
PHONE_METADATA_VC = PhoneMetadata(id='VC', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='784(?:266|3(?:6[6-9]|7\\d|8[0-24-6])|4(?:38|5[0-36-8]|8\\d|9[01])|555|638|784)\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='7842661234'),
    mobile=PhoneNumberDesc(national_number_pattern='784(?:4(?:3[0-24]|5[45]|9[2-5])|5(?:2[6-9]|3[0-3]|93))\\d{4}', possible_number_pattern='\\d{10}', example_number='7844301234'),
