...
PHONE_METADATA_VE = PhoneMetadata(id='VE', country_code=58, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:2(?:12|3[457-9]|[58][1-9]|[467]\\d|9[1-6])|50[01])\\d{7}', possible_number_pattern='\\d{7,10}', example_number='2121234567', possible_length=(10,), possible_length_local_only=(7,)),
