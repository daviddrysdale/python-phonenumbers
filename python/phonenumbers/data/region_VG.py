...
PHONE_METADATA_VG = PhoneMetadata(id='VG', country_code=1, international_prefix='011',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='284(?:(?:3(?:0[0-3]|4[0-367]|94)|4(?:4[0-6]|68|99)|54[0-57])\\d{4}|496[6-9]\\d{3})', example_number='2843001234', possible_length=(10,), possible_length_local_only=(7,)),
