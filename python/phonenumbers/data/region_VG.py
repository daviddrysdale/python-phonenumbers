...
PHONE_METADATA_VG = PhoneMetadata(id='VG', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='284(?:(?:229|4(?:22|9[45])|774|8(?:52|6[459]))\\d{4}|496[0-5]\\d{3})', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='2842291234', possible_length=(10,), possible_length_local_only=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='284(?:(?:3(?:0[0-3]|4[0-367]|94)|4(?:4[0-6]|68|99)|54[0-57])\\d{4}|496[6-9]\\d{3})', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='2843001234', possible_length=(10,), possible_length_local_only=(7,)),
