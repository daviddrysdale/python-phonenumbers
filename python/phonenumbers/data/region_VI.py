...
PHONE_METADATA_VI = PhoneMetadata(id='VI', country_code=1, international_prefix='011',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='340(?:2(?:01|2[067]|36|44|77)|3(?:32|44)|4(?:4[38]|7[34])|5(?:1[34]|55)|6(?:26|4[23]|77|9[023])|7(?:[17]\\d|27)|884|998)\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='3406421234'),
    mobile=PhoneNumberDesc(national_number_pattern='340(?:2(?:01|2[067]|36|44|77)|3(?:32|44)|4(?:4[38]|7[34])|5(?:1[34]|55)|6(?:26|4[23]|77|9[023])|7(?:[17]\\d|27)|884|998)\\d{4}', possible_number_pattern='\\d{7}(?:\\d{3})?', example_number='3406421234'),
