...
PHONE_METADATA_VN = PhoneMetadata(id='VN', country_code=84, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='121[0-3]\\d{5}|(?:1[46]0|(?:3\\d|7[06-9])\\d|5(?:[1689]\\d|2[238]|59)|8(?:[1-8]\\d|9[6-9])|9(?:[0-8]\\d|9[013-9]))\\d{6}', example_number='912345678', possible_length=(9,)),
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{4})', format='\\1 \\2', leading_digits_pattern=['[17]99'], national_prefix_formatting_rule='0\\1', national_prefix_optional_when_formatting=True),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['[1357-9]'], national_prefix_formatting_rule='0\\1', national_prefix_optional_when_formatting=True),
    ...
    intl_number_format=[NumberFormat(pattern='(\\d{4})(\\d{4,6})', format='\\1 \\2', leading_digits_pattern=['1(?:2[02]|[89])']),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['[1357-9]']),
