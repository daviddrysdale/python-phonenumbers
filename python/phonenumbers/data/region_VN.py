...
PHONE_METADATA_VN = PhoneMetadata(id='VN', country_code=84, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:52[238]|8(?:79|9[689])|99[013-9])\\d{6}|(?:3\\d|5[689]|7[06-9]|8[1-68]|9[0-8])\\d{7}', example_number='912345678', possible_length=(9,)),
    toll_free=PhoneNumberDesc(national_number_pattern='1800\\d{4,6}|12(?:03|28)\\d{4}', example_number='1800123456', possible_length=(8, 9, 10)),
