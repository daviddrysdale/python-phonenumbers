...
PHONE_METADATA_VU = PhoneMetadata(id='VU', country_code=678, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[48]8\\d{3}|(?:[23]|[579]\\d\\d)\\d{4}', possible_length=(5, 7)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:5\\d|7[013-7])\\d{5}', example_number='5912345', possible_length=(7,)),
