...
PHONE_METADATA_WF = PhoneMetadata(id='WF', country_code=681, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:50|68|72)\\d{4}', possible_number_pattern='\\d{6}', example_number='501234', possible_length=(6,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:50|68|72|8[23])\\d{4}', possible_number_pattern='\\d{6}', example_number='501234', possible_length=(6,)),
