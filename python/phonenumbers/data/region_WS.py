...
PHONE_METADATA_WS = PhoneMetadata(id='WS', country_code=685, international_prefix='0',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:[2-6]|8\\d(?:\\d{4})?)\\d{4}|[78]\\d{6}', possible_length=(5, 6, 7, 10)),
    ...
    number_format=[NumberFormat(pattern='(8\\d{2})(\\d{3,7})', format='\\1 \\2', leading_digits_pattern=['8']),
