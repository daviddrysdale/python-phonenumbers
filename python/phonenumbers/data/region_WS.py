...
PHONE_METADATA_WS = PhoneMetadata(id='WS', country_code=685, international_prefix='0',
    ...
    number_format=[NumberFormat(pattern='(8\\d{2})(\\d{3,4})', format=u'\\1 \\2', leading_digits_pattern=['8']),
        NumberFormat(pattern='(7\\d)(\\d{5})', format=u'\\1 \\2', leading_digits_pattern=['7'])])
