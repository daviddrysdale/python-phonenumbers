...
PHONE_METADATA_ZA = PhoneMetadata(id='ZA', country_code=27, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[1-79]\\d{8}|8\\d{4,8}', possible_number_pattern='\\d{5,9}', possible_length=(5, 6, 7, 8, 9)),
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1[0-8]|2[1-378]|3[1-69]|4\\d|5[1346-8])\\d{7}', possible_number_pattern='\\d{9}', example_number='101234567', possible_length=(9,)),
