...
PHONE_METADATA_ZM = PhoneMetadata(id='ZM', country_code=260, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:63|80)0\\d{6}|(?:21|[79]\\d)\\d{7}', possible_length=(9,), possible_length_local_only=(6,)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:7[67]|9[5-8])\\d{7}', example_number='955123456', possible_length=(9,)),
    toll_free=PhoneNumberDesc(national_number_pattern='800\\d{6}', example_number='800123456', possible_length=(9,)),
    voip=PhoneNumberDesc(national_number_pattern='630\\d{6}', example_number='630012345', possible_length=(9,)),
    national_prefix='0',
