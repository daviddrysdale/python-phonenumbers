...
PHONE_METADATA_ZM = PhoneMetadata(id='ZM', country_code=260, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:(?:21|76|9\\d)\\d|800)\\d{6}', possible_length=(9,), possible_length_local_only=(6, 7)),
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{4})', format='\\1 \\2', national_prefix_formatting_rule='\\1'),
        ...
        NumberFormat(pattern='([279]\\d)(\\d{7})', format='\\1 \\2', leading_digits_pattern=['[279]'], national_prefix_formatting_rule='0\\1'),
