...
PHONE_METADATA_ZW = PhoneMetadata(id='ZW', country_code=263, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='7[137]\\d{7}|86(?:22|44)\\d{6}', possible_number_pattern='\\d{9,10}', example_number='711234567'),
    toll_free=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA'),
    premium_rate=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA'),
    shared_cost=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA'),
    personal_number=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA'),
    voip=PhoneNumberDesc(national_number_pattern='86(?:1[12]|30|8[367]|99)\\d{6}', possible_number_pattern='\\d{10}', example_number='8686123456'),
    ...
    number_format=[NumberFormat(pattern='([49])(\\d{3})(\\d{2,5})', format=u'\\1 \\2 \\3', leading_digits_pattern=['4|9[2-9]'], national_prefix_formatting_rule=u'0\\1'),
        ...
        NumberFormat(pattern='(8\\d{3})(\\d{6})', format=u'\\1 \\2', leading_digits_pattern=['86[1389]'], national_prefix_formatting_rule=u'0\\1')])
