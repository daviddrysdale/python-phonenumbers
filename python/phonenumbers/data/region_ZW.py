...
PHONE_METADATA_ZW = PhoneMetadata(id='ZW', country_code=263, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern=u'2(?:[012457-9]\d{3,8}|6\d{3,6})|[13-79]\d{4,8}|86\d{8}', possible_number_pattern=u'\d{3,10}'),
    fixed_line=PhoneNumberDesc(national_number_pattern=u'(?:1[3-9]|2(?:0[45]|[16]|2[28]|[49]8?|58[23]|7[246]|8[1346-9])|3(?:08?|17?|3[78]|[2456]|7[1569]|8[379])|5(?:[07-9]|1[78]|483|5(?:7?|8))|6(?:0|28|37?|[45][68][78]|98?)|848)\d{3,6}|(?:2(?:27|5|7[135789]|8[25])|3[39]|5[1-46]|6[126-8])\d{4,6}|2(?:0|70)\d{5,6}|(?:4\d|9[2-8])\d{4,7}', possible_number_pattern=u'\d{3,10}', example_number=u'1312345'),
    mobile=PhoneNumberDesc(national_number_pattern=u'7[137]\d{7}', possible_number_pattern=u'\d{9}', example_number=u'711234567'),
    ...
    voip=PhoneNumberDesc(national_number_pattern=u'86(?:1[12]|22|30|44|8[367]|99)\d{6}', possible_number_pattern=u'\d{10}', example_number=u'8686123456'),
