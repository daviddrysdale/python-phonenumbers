...
PHONE_METADATA_ZW = PhoneMetadata(id='ZW', country_code=263, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='2(?:[012457-9]\\d{3,8}|6(?:[14]\\d{7}|\\d{4}))|[13-79]\\d{4,9}|8[06]\\d{8}', possible_length=(5, 6, 7, 8, 9, 10), possible_length_local_only=(3, 4)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='7[1378]\\d{7}', example_number='711234567', possible_length=(9,)),
    toll_free=PhoneNumberDesc(national_number_pattern='800\\d{7}', example_number='8001234567', possible_length=(10,)),
    voip=PhoneNumberDesc(national_number_pattern='86(?:1[12]|30|44|55|77|8[367]|99)\\d{6}', example_number='8686123456', possible_length=(10,)),
    national_prefix='0',
