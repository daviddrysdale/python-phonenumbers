...
_PHONENUMBER_COUNTRYCODESOURCE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FROM_NUMBER_WITH_PLUS_SIGN', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FROM_NUMBER_WITH_IDD', index=2, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FROM_NUMBER_WITHOUT_PLUS_SIGN', index=3, number=10,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FROM_DEFAULT_COUNTRY', index=4, number=20,
      options=None,
      type=None),
  ],
