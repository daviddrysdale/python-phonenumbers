...
class PhoneMetadata(UnicodeMixin, ImmutableMixin):
    ...
    short_data: bool
    @classmethod
    def metadata_for_region(kls, region_code: str, default: PhoneMetadata | None = ...) -> PhoneMetadata | None: ...
    @classmethod
    def short_metadata_for_region(kls, region_code: str, default: PhoneMetadata | None = ...) -> PhoneMetadata | None: ...
    @classmethod
    def metadata_for_nongeo_region(kls, country_code: int, default: PhoneMetadata | None = ...) -> PhoneMetadata | None: ...
    @classmethod
    def metadata_for_region_or_calling_code(kls, country_calling_code: int, region_code: str) -> PhoneMetadata | None: ...
    @classmethod
