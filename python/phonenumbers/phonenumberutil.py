...
def length_of_geographical_area_code(numobj):
    ...
    """
    metadata = PhoneMetadata.region_metadata.get(region_code_for_number(numobj), None)
    if metadata is None:
        return 0
...
def _prefix_number_with_country_calling_code(country_code, num_format, formatted_number):
    ...
    if num_format == PhoneNumberFormat.E164:
        ...
        return _RFC3966_PREFIX + _PLUS_SIGN + unicode(country_code) + u"-" + formatted_number
    else:
        return formatted_number
