...
PHONE_METADATA_AM = PhoneMetadata(id='AM', country_code=None, international_prefix=None,
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='[18]\\d{2,3}', possible_number_pattern='\\d{3,4}'),
    mobile=PhoneNumberDesc(national_number_pattern='[18]\\d{2,3}', possible_number_pattern='\\d{3,4}'),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='8[1-7]\\d{2}|1(?:0[04-9]|[1-9]\\d)', possible_number_pattern='\\d{3,4}', example_number='8711'),
