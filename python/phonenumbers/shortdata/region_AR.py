...
PHONE_METADATA_AR = PhoneMetadata(id='AR', country_code=None, international_prefix=None,
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='000|1(?:0[0-35-7]|1[0245]|2[015]|34|4[78]|9)|911', example_number='19', possible_length=(2, 3)),
    emergency=PhoneNumberDesc(national_number_pattern='10[017]|911', example_number='100', possible_length=(3,)),
    short_code=PhoneNumberDesc(national_number_pattern='000|1(?:0[0-35-7]|1[02-5]|2[015]|34|4[78]|9)|3372|89338|911', example_number='19', possible_length=(2, 3, 4, 5)),
