...
PHONE_METADATA_BA = PhoneMetadata(id='BA', country_code=None, international_prefix=None,
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:1(?:6(?:00[06]|1(?:1[17]|23))|8\\d\\d?)|2(?:0[0-7]|[2-5]|6[0-26]|[78]\\d\\d?)|(?:[3-5]|7\\d)\\d\\d)', example_number='122', possible_length=(3, 4, 5, 6)),
    short_data=True)
