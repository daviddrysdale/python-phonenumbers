...
PHONE_METADATA_BB = PhoneMetadata(id='BB', country_code=None, international_prefix=None,
    general_desc=PhoneNumberDesc(national_number_pattern='[235]\\d{2}', possible_number_pattern='\\d{3}'),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='[235]11', possible_number_pattern='\\d{3}', example_number='211'),
