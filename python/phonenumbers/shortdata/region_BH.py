...
PHONE_METADATA_BH = PhoneMetadata(id='BH', country_code=None, international_prefix=None,
    ...
    short_code=PhoneNumberDesc(national_number_pattern='(?:0[167]|8[158])\\d{3}|1(?:[02]\\d|12|4[01]|51|8[18]|9[169])|9(?:[148]\\d{3}|9[02489])', example_number='100', possible_length=(3, 5)),
    carrier_specific=PhoneNumberDesc(national_number_pattern='(?:0[67]\\d|880|985)\\d\\d', example_number='06000', possible_length=(5,)),
    sms_services=PhoneNumberDesc(national_number_pattern='(?:880|985)\\d\\d', example_number='88000', possible_length=(5,)),
    short_data=True)
