...
PHONE_METADATA_BR = PhoneMetadata(id='BR', country_code=None, international_prefix=None,
    general_desc=PhoneNumberDesc(national_number_pattern='[1249]\\d{2,4}', possible_number_pattern='\\d{3,5}'),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:0(?:0|[36]\\d{2}|5\\d)|[15][26]|2[38]|68|81|9[0-5789])|27(?:330|878)|40404|911', possible_number_pattern='\\d{3,5}', example_number='168'),
