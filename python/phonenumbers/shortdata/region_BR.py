...
PHONE_METADATA_BR = PhoneMetadata(id='BR', country_code=None, international_prefix=None,
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:0(?:0|[36]\\d{2}|5\\d)|[15][26]|2[38]|68|81|9[0-5789])|27878|40404|911', possible_number_pattern='\\d{3,5}', example_number='168'),
