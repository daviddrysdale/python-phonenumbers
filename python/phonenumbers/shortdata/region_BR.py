...
PHONE_METADATA_BR = PhoneMetadata(id='BR', country_code=None, international_prefix=None,
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='1(?:00|81)|4828', possible_number_pattern='\\d{3,4}', example_number='181'),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:0(?:0|[36]\\d{2}|5\\d)|[15][26]|2[38]|68|81|9[0-5789])|2(?:7(?:330|878)|85959?)|4(?:0404|828)|911', possible_number_pattern='\\d{3,6}', example_number='168'),
