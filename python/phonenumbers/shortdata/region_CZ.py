...
PHONE_METADATA_CZ = PhoneMetadata(id='CZ', country_code=None, international_prefix=None,
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='1\\d{3,5}', possible_number_pattern='\\d{4,6}'),
    mobile=PhoneNumberDesc(national_number_pattern='1\\d{3,5}', possible_number_pattern='\\d{4,6}'),
