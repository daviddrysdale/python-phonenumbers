...
PHONE_METADATA_FI = PhoneMetadata(id='FI', country_code=None, international_prefix=None,
    ...
    short_code=PhoneNumberDesc(national_number_pattern='11(?:2|6(?:00[06]|1(?:1[17]|23)))|(?:1[235-8]\\d|75[12])\\d\\d', example_number='112', possible_length=(3, 5, 6)),
    standard_rate=PhoneNumberDesc(national_number_pattern='1[235-8]\\d{3}', example_number='12000', possible_length=(5,)),
    short_data=True)
