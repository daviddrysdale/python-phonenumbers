...
PHONE_METADATA_FR = PhoneMetadata(id='FR', country_code=None, international_prefix=None,
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='1(?:0(?:07|13)|1(?:[02459]|6\\d{3})|[578]|9[167])|224|3(?:[01]\\d\\d|3700)|740', example_number='15', possible_length=(2, 3, 4, 5, 6)),
    ...
    standard_rate=PhoneNumberDesc(national_number_pattern='10(?:[13]4|2[23]|6[14]|99)|202\\d|3(?:646|9[07]0)|6(?:1[14]|34)|70[06]', example_number='611', possible_length=(3, 4)),
    carrier_specific=PhoneNumberDesc(national_number_pattern='118777|2(?:0(?:0\\d|2)\\d|24)|6(?:1[14]|34)|7(?:0[06]|22|40)', example_number='224', possible_length=(3, 4, 5, 6)),
