...
PHONE_METADATA_GI = PhoneMetadata(id='GI', country_code=None, international_prefix=None,
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='1(?:00|16\\d{3}|23|47\\d|5[15]|9[2-4])|555', example_number='100', possible_length=(3, 4, 6)),
    emergency=PhoneNumberDesc(national_number_pattern='1(?:12|9[09])', example_number='112', possible_length=(3,)),
    short_code=PhoneNumberDesc(national_number_pattern='1(?:00|1(?:2|6(?:00[06]|1(?:1[17]|23))|8\\d{2})|23|4(?:1|7[014])|5[015]|9[02349])|555|8(?:008?|4[0-2]|88)', example_number='116000', possible_length=(3, 4, 5, 6)),
    standard_rate=PhoneNumberDesc(national_number_pattern='150', example_number='150', possible_length=(3,)),
