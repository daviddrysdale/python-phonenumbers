...
PHONE_METADATA_GY = PhoneMetadata(id='GY', country_code=None, international_prefix=None,
    general_desc=PhoneNumberDesc(national_number_pattern='[09]\\d{2,3}', possible_number_pattern='\\d{3,4}'),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='0(?:02|171|444|7[67]7|801|9(?:0[78]|[2-47]))|91[123]', possible_number_pattern='\\d{3,4}', example_number='0801'),
