...
PHONE_METADATA_HR = PhoneMetadata(id='HR', country_code=None, international_prefix=None,
    general_desc=PhoneNumberDesc(national_number_pattern='[19]\\d{1,2}', possible_number_pattern='\\d{2,3}'),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:12|92)|9[34]', possible_number_pattern='\\d{2,3}', example_number='112'),
