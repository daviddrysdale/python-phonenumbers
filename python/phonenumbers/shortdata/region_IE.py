...
PHONE_METADATA_IE = PhoneMetadata(id='IE', country_code=None, international_prefix=None,
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:1(?:2|6(?:00[06]|1(?:1[17]|23))|8\\d\\d)|9\\d\\d)|5[0137]\\d{3}|999', example_number='112', possible_length=(3, 4, 5, 6)),
    ...
    sms_services=PhoneNumberDesc(national_number_pattern='118\\d\\d|5(?:[037]\\d{3}|1210)', example_number='11800', possible_length=(5,)),
    short_data=True)
