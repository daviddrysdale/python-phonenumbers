...
PHONE_METADATA_IN = PhoneMetadata(id='IN', country_code=None, international_prefix=None,
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:0[0128]|12|298)|2611|5(?:3000|757555)', possible_number_pattern='\\d{3,7}', example_number='108'),
    standard_rate=PhoneNumberDesc(national_number_pattern='5757555', possible_number_pattern='\\d{7}', example_number='5757555'),
