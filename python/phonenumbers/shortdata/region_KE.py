...
PHONE_METADATA_KE = PhoneMetadata(id='KE', country_code=None, international_prefix=None,
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:0(?:[09]|400)|1(?:[026]|9[0-2579])|2[13]|3[01])|40404|8988|999', possible_number_pattern='\\d{3,5}', example_number='116'),
