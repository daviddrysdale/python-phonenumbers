...
PHONE_METADATA_KR = PhoneMetadata(id='KR', country_code=None, international_prefix=None,
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='1(?:1[78]|28|82)', possible_number_pattern='\\d{3}', example_number='118'),
    premium_rate=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA'),
    emergency=PhoneNumberDesc(national_number_pattern='11[29]', possible_number_pattern='\\d{3,4}', example_number='112'),
    short_code=PhoneNumberDesc(national_number_pattern='1(?:0[01]|1[027-9]|2[01389]|3(?:2|39|9[18])|82)', possible_number_pattern='\\d{3,4}', example_number='112'),
