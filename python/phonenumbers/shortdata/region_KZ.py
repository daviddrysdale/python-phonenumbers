...
PHONE_METADATA_KZ = PhoneMetadata(id='KZ', country_code=None, international_prefix=None,
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:0[123]|12)|30400', possible_number_pattern='\\d{3,5}', example_number='112'),
    standard_rate=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA'),
    carrier_specific=PhoneNumberDesc(national_number_pattern='30400', possible_number_pattern='\\d{5}', example_number='30400'),
    short_data=True)
