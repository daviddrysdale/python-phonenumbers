...
PHONE_METADATA_MD = PhoneMetadata(id='MD', country_code=None, international_prefix=None,
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:1(?:2|6(?:000|1(?:11|23))|8\\d\\d?|99)|(?:4\\d\\d|6[0-389])\\d|9(?:0[04-9]|[1-4]\\d))|90[1-3]', example_number='112', possible_length=(3, 4, 5, 6)),
    short_data=True)
