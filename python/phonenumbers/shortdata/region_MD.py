...
PHONE_METADATA_MD = PhoneMetadata(id='MD', country_code=None, international_prefix=None,
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:1(?:[279]|6(?:000|1(?:11|23))|8\\d)|4\\d{3}|5[0-3]\\d|6[0-389]\\d|8\\d{2}|9(?:0[0-9]|[1-4]\\d))', possible_number_pattern='\\d{3,6}', example_number='116000'),
