...
PHONE_METADATA_NA = PhoneMetadata(id='NA', country_code=None, international_prefix=None,
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='[19]\\d{2,4}', possible_number_pattern='\\d{3,5}'),
    mobile=PhoneNumberDesc(national_number_pattern='[19]\\d{2,4}', possible_number_pattern='\\d{3,5}'),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1\\d{3}|9(?:3111|\\d{2})', possible_number_pattern='\\d{3,5}', example_number='93111'),
