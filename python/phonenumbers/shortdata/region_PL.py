...
PHONE_METADATA_PL = PhoneMetadata(id='PL', country_code=None, international_prefix=None,
    general_desc=PhoneNumberDesc(national_number_pattern='1\\d{2}(?:\\d{3})?|9\\d{2}', possible_length=(3, 6)),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='11(?:2|6(?:000|1(?:11|23)))|9(?:8[4-7]|9[1-9])', example_number='112', possible_length=(3, 6)),
    short_data=True)
