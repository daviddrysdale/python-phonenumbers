...
PHONE_METADATA_QA = PhoneMetadata(id='QA', country_code=None, international_prefix=None,
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='[129]\\d{2,4}', possible_number_pattern='\\d{3,5}'),
    mobile=PhoneNumberDesc(national_number_pattern='[129]\\d{2,4}', possible_number_pattern='\\d{3,5}'),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='(?:1|20|9[27]\\d)\\d{2}', possible_number_pattern='\\d{3,5}', example_number='2012'),
