...
PHONE_METADATA_SA = PhoneMetadata(id='SA', country_code=None, international_prefix=None,
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='[19]\\d{2,5}', possible_number_pattern='\\d{3,6}'),
    mobile=PhoneNumberDesc(national_number_pattern='[19]\\d{2,5}', possible_number_pattern='\\d{3,6}'),
