...
PHONE_METADATA_SA = PhoneMetadata(id='SA', country_code=None, international_prefix=None,
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:1(?:00|2|6111)|410|9(?:00|1[89]|9(?:099|22|9[12])))|9(?:0[24-79]|11|3[379]|40|66|8[5-9]|9[02-9])', example_number='112', possible_length=(3, 4, 5, 6)),
