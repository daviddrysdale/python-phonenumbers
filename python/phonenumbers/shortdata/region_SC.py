...
PHONE_METADATA_SC = PhoneMetadata(id='SC', country_code=None, international_prefix=None,
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:0\\d|1[027]|2[0-8]|3[13]|4[0-2]|[59][15]|6[1-9]|7[124-6]|8[158])|96\\d{2}', possible_number_pattern='\\d{3,4}', example_number='100'),
