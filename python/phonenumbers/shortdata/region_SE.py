...
PHONE_METADATA_SE = PhoneMetadata(id='SE', country_code=None, international_prefix=None,
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='11(?:2|6\\d{3})|900\\d\\d', example_number='112', possible_length=(3, 5, 6)),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='11(?:[25]|313|4\\d\\d|6(?:00[06]|1(?:1[17]|23))|7[0-8]|8(?:[02-46-9]\\d\\d|1(?:[02-9]\\d|1[013-9])))|2(?:2[02358]|33|4[01]|50|6[1-4])|32[13]|7\\d{4}|8(?:22|88)|9(?:0(?:(?:00|51)0|1(?:[02-9]\\d|1[013-9])|[2-4]\\d\\d)|12)', example_number='112', possible_length=(3, 4, 5, 6)),
