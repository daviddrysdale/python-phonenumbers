...
PHONE_METADATA_SG = PhoneMetadata(id='SG', country_code=None, international_prefix=None,
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:[0136]\\d{2}|[89](?:[1-9]\\d|0[1-9])|[57]\\d{2,3})|99[02-9]', possible_number_pattern='\\d{3,5}', example_number='1312', possible_length=(3, 4, 5)),
