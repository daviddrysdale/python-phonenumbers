...
PHONE_METADATA_SH = PhoneMetadata(id='SH', country_code=None, international_prefix=None,
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='1\\d{2,3}', possible_number_pattern='\\d{3,4}'),
    mobile=PhoneNumberDesc(national_number_pattern='1\\d{2,3}', possible_number_pattern='\\d{3,4}'),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1\\d{2,3}', possible_number_pattern='\\d{3,4}', example_number='1234'),
