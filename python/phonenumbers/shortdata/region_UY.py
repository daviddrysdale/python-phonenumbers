...
PHONE_METADATA_UY = PhoneMetadata(id='UY', country_code=None, international_prefix=None,
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='1\\d{2}', possible_number_pattern='\\d{3}'),
    mobile=PhoneNumberDesc(national_number_pattern='1\\d{2}', possible_number_pattern='\\d{3}'),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:0[4-9]|1[2368]|2[0-3568])', possible_number_pattern='\\d{3}', example_number='104'),
