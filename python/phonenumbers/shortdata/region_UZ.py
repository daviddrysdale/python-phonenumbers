...
PHONE_METADATA_UZ = PhoneMetadata(id='UZ', country_code=None, international_prefix=None,
    general_desc=PhoneNumberDesc(national_number_pattern='0\\d{1,2}', possible_number_pattern='\\d{2,3}'),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='0(?:0[123]|[123]|50)', possible_number_pattern='\\d{2,3}', example_number='01'),
