...
distutils.core.setup(name='phonenumbers',
                     ...
                     package_data={'phonenumbers.geodata': ['phonenumbers/geodata/geodata.db'],
                                   'phonenumbers.carrierdata': ['phonenumbers/carrierdata/carrierdata.db'],
                                   'phonenumbers.tzdata': ['phonenumbers/carrierdata/tzdata.db']},
                     test_suite="tests",
