...
AO_MOBILE1 = FrozenPhoneNumber(country_code=244, national_number=917654321L)
AO_MOBILE2 = FrozenPhoneNumber(country_code=244, national_number=927654321L)
AO_FIXED1 = FrozenPhoneNumber(country_code=244, national_number=22254321L)
AO_FIXED2 = FrozenPhoneNumber(country_code=244, national_number=26254321L)
AO_INVALID_NUMBER = FrozenPhoneNumber(country_code=244, national_number=101234L)
UK_MOBILE1 = FrozenPhoneNumber(country_code=44, national_number=7387654321L)
UK_MOBILE2 = FrozenPhoneNumber(country_code=44, national_number=7487654321L)
UK_FIXED1 = FrozenPhoneNumber(country_code=44, national_number=1123456789L)
UK_FIXED2 = FrozenPhoneNumber(country_code=44, national_number=2987654321L)
UK_INVALID_NUMBER = FrozenPhoneNumber(country_code=44, national_number=7301234L)
UK_PAGER = FrozenPhoneNumber(country_code=44, national_number=7601234567L)
US_FIXED_OR_MOBILE = FrozenPhoneNumber(country_code=1, national_number=6502123456L)
