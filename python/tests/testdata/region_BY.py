...
PHONE_METADATA_BY = PhoneMetadata(id='BY', country_code=375, international_prefix='810',
    ...
    number_format=[NumberFormat(pattern='(\\d{4})', format=u'\\1', leading_digits_pattern=['[1-8]'], national_prefix_formatting_rule=u'8 \\1'),
        NumberFormat(pattern='(\\d{2})(\\d{3})', format=u'\\1 \\2', leading_digits_pattern=['[1-8]'], national_prefix_formatting_rule=u'8\\1'),
        NumberFormat(pattern='(\\d{3})(\\d{3})', format=u'\\1 \\2', leading_digits_pattern=['[1-8]'], national_prefix_formatting_rule=u'8 \\1')])
