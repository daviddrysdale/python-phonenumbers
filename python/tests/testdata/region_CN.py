...
PHONE_METADATA_CN = PhoneMetadata(id='CN', country_code=86, international_prefix=None,
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='[2-9]\\d{10}', possible_number_pattern='\\d{11}', example_number='91234567'),
    mobile=PhoneNumberDesc(national_number_pattern='1(?:[38]\\d|4[57]|5[0-35-9]|7[0136-8])\\d{8}', possible_number_pattern='\\d{11}', example_number='13123456789'),
