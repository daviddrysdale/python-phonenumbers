...
PHONE_METADATA_JP = PhoneMetadata(id='JP', country_code=81, international_prefix='010',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='07\\d{5}|[1-357-9]\\d{3,10}', possible_number_pattern='\\d{4,11}', possible_length=(4, 5, 6, 7, 8, 9, 10, 11)),
    mobile=PhoneNumberDesc(national_number_pattern='07\\d{5}|[1-357-9]\\d{3,10}', possible_number_pattern='\\d{4,11}', possible_length=(4, 5, 6, 7, 8, 9, 10, 11)),
