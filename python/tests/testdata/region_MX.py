...
PHONE_METADATA_MX = PhoneMetadata(id='MX', country_code=52, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='[2-9]\\d{9}', possible_number_pattern='\\d{7,10}'),
    mobile=PhoneNumberDesc(national_number_pattern='1\\d{10}', possible_number_pattern='\\d{11}'),
