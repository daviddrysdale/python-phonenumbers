...
PHONE_METADATA_MX = PhoneMetadata(id='MX', country_code=52, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[89]00'], national_prefix_formatting_rule=u'01 \\1'),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{4})', format=u'\\1 \\2 \\3', leading_digits_pattern=['[2467]|3[0-24-9]|5[0-46-9]|8[2-9]|9[1-9]'], national_prefix_formatting_rule=u'01 \\1'),
        NumberFormat(pattern='(1)(\\d{2})(\\d{4})(\\d{4})', format=u'045 \\2 \\3 \\4', leading_digits_pattern=['1(?:33|55|81)'], national_prefix_formatting_rule=u'\\1'),
        NumberFormat(pattern='(1)(\\d{3})(\\d{3})(\\d{4})', format=u'045 \\2 \\3 \\4', leading_digits_pattern=['1(?:[124579]|3[0-24-9]|5[0-46-9]|8[02-9])'], national_prefix_formatting_rule=u'\\1')],
