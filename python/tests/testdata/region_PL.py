...
PHONE_METADATA_PL = PhoneMetadata(id='PL', country_code=48, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='[1-9]\\d{8}', possible_number_pattern='\\d{9}', possible_length=(9,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:5[01]|6[069]|7[289]|88)\\d{7}', possible_number_pattern='\\d{9}', possible_length=(9,)),
