...
PHONE_METADATA_YT = PhoneMetadata(id='YT', country_code=262, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2696[0-4]\\d{4}', possible_number_pattern='\\d{9}', example_number='269601234', possible_length=[9]),
    mobile=PhoneNumberDesc(national_number_pattern='639\\d{6}', possible_number_pattern='\\d{9}', example_number='639123456', possible_length=[9]),
