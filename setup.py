...
distutils.core.setup(name='phonenumbers',
                     ...
                     package_dir={'': 'python'},
                     package_data={'phonenumbers.geodata': ['python/phonenumbers/geodata/geodata.db'],
                                   'phonenumbers.carrierdata': ['python/phonenumbers/carrierdata/carrierdata.db'],
                                   'phonenumbers.tzdata': ['python/phonenumbers/carrierdata/tzdata.db']},
                     test_suite="tests",
